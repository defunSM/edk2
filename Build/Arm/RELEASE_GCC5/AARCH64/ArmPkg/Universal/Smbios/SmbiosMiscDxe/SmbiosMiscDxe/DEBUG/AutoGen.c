...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x7e5e26d4, 0x0be9, 0x401f, {0xb5, 0xe1, 0x1c, 0x2b, 0xda, 0x7c, 0xa7, 0x77}};

GLOBAL_REMOVE_IF_UNREFERENCED GUID gEdkiiDscPlatformGuid = {0x5CFBD99E, 0x3C43, 0x4E7F, {0x80, 0x54, 0x9C, 0xDE, 0xAF, 0xF7, 0x71, 0x0F}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "SmbiosMiscDxe";
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT16 _gPcd_FixedAtBuild_PcdSystemBiosRelease = _PCD_VALUE_PcdSystemBiosRelease;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT16 _gPcd_FixedAtBuild_PcdEmbeddedControllerFirmwareRelease = _PCD_VALUE_PcdEmbeddedControllerFirmwareRelease;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT16 _gPcd_FixedAtBuild_PcdSystemProductName[1] = {0 };
GLOBAL_REMOVE_IF_UNREFERENCED const UINTN _gPcd_FixedAtBuild_Size_PcdSystemProductName = 2;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT16 _gPcd_FixedAtBuild_PcdSystemVersion[1] = {0 };
GLOBAL_REMOVE_IF_UNREFERENCED const UINTN _gPcd_FixedAtBuild_Size_PcdSystemVersion = 2;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT16 _gPcd_FixedAtBuild_PcdBaseBoardManufacturer[1] = {0 };
GLOBAL_REMOVE_IF_UNREFERENCED const UINTN _gPcd_FixedAtBuild_Size_PcdBaseBoardManufacturer = 2;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT16 _gPcd_FixedAtBuild_PcdBaseBoardProductName[1] = {0 };
GLOBAL_REMOVE_IF_UNREFERENCED const UINTN _gPcd_FixedAtBuild_Size_PcdBaseBoardProductName = 2;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT16 _gPcd_FixedAtBuild_PcdBaseBoardVersion[1] = {0 };
GLOBAL_REMOVE_IF_UNREFERENCED const UINTN _gPcd_FixedAtBuild_Size_PcdBaseBoardVersion = 2;
...
#define _PCD_TOKEN_PcdVerifyNodeInList  61U
...
#define _PCD_TOKEN_PcdMaximumLinkedListLength  51U
...
#define _PCD_TOKEN_PcdMaximumAsciiStringLength  49U
...
#define _PCD_TOKEN_PcdMaximumUnicodeStringLength  52U
...
#define _PCD_TOKEN_PcdControlFlowEnforcementPropertyMask  42U
...
#define _PCD_TOKEN_PcdSpeculationBarrierType  54U
...
#define _PCD_TOKEN_PcdMaximumDevicePathNodeCount  50U
...
#define _PCD_TOKEN_PcdDriverDiagnosticsDisable  48U
...
#define _PCD_TOKEN_PcdComponentNameDisable  41U
...
#define _PCD_TOKEN_PcdDriverDiagnostics2Disable  47U
...
#define _PCD_TOKEN_PcdComponentName2Disable  40U
...
#define _PCD_TOKEN_PcdUefiLibMaxPrintBufferSize  59U
...
{
  return SmbiosMiscEntryPoint (ImageHandle, SystemTable);
}
...
//
unsigned char SmbiosMiscDxeStrings[] = {
...
// PACKAGE HEADER
  ...
  0xA1,  0x02,  0x00,  0x04,  0x34,  0x00,  0x00,  0x00,  0x34,  0x00,  0x00,  0x00,  0x00,  0x00,  0x00,  0x00,  
...
// 0x0001: $PRINTABLE_LANGUAGE_NAME:0x0001
  ...
  0x00,
// 0x0002: STR_MISC_BIOS_VENDOR:0x0002
  0x14,  0x4E,  0x00,  0x6F,  0x00,  0x74,  0x00,  0x20,  0x00,  0x53,  0x00,  0x70,  0x00,  0x65,  0x00,  0x63,  
  0x00,  0x69,  0x00,  0x66,  0x00,  0x69,  0x00,  0x65,  0x00,  0x64,  0x00,  0x00,  0x00,
// 0x0003: STR_MISC_BIOS_VERSION:0x0003
  0x14,  0x4E,  0x00,  0x6F,  0x00,  0x74,  0x00,  0x20,  0x00,  0x53,  0x00,  0x70,  0x00,  0x65,  0x00,  0x63,  
  0x00,  0x69,  0x00,  0x66,  0x00,  0x69,  0x00,  0x65,  0x00,  0x64,  0x00,  0x00,  0x00,
// 0x0004: STR_MISC_BIOS_RELEASE_DATE:0x0004
  0x14,  0x31,  0x00,  0x32,  0x00,  0x2F,  0x00,  0x30,  0x00,  0x32,  0x00,  0x2F,  0x00,  0x32,  0x00,  0x30,  
  0x00,  0x32,  0x00,  0x30,  0x00,  0x00,  0x00,
// 0x0005: STR_MISC_SYSTEM_MANUFACTURER:0x0005
  0x14,  0x4E,  0x00,  0x6F,  0x00,  0x74,  0x00,  0x20,  0x00,  0x53,  0x00,  0x70,  0x00,  0x65,  0x00,  0x63,  
  0x00,  0x69,  0x00,  0x66,  0x00,  0x69,  0x00,  0x65,  0x00,  0x64,  0x00,  0x00,  0x00,
// 0x0006: STR_MISC_SYSTEM_PRODUCT_NAME:0x0006
  0x14,  0x4E,  0x00,  0x6F,  0x00,  0x74,  0x00,  0x20,  0x00,  0x53,  0x00,  0x70,  0x00,  0x65,  0x00,  0x63,  
  0x00,  0x69,  0x00,  0x66,  0x00,  0x69,  0x00,  0x65,  0x00,  0x64,  0x00,  0x00,  0x00,
// 0x0007: STR_MISC_SYSTEM_VERSION:0x0007
  0x14,  0x4E,  0x00,  0x6F,  0x00,  0x74,  0x00,  0x20,  0x00,  0x53,  0x00,  0x70,  0x00,  0x65,  0x00,  0x63,  
  0x00,  0x69,  0x00,  0x66,  0x00,  0x69,  0x00,  0x65,  0x00,  0x64,  0x00,  0x00,  0x00,
// 0x0008: STR_MISC_SYSTEM_SERIAL_NUMBER:0x0008
  0x14,  0x4E,  0x00,  0x6F,  0x00,  0x74,  0x00,  0x20,  0x00,  0x53,  0x00,  0x70,  0x00,  0x65,  0x00,  0x63,  
  0x00,  0x69,  0x00,  0x66,  0x00,  0x69,  0x00,  0x65,  0x00,  0x64,  0x00,  0x00,  0x00,
// 0x0009: STR_MISC_SYSTEM_SKU_NUMBER:0x0009
  0x14,  0x4E,  0x00,  0x6F,  0x00,  0x74,  0x00,  0x20,  0x00,  0x53,  0x00,  0x70,  0x00,  0x65,  0x00,  0x63,  
  0x00,  0x69,  0x00,  0x66,  0x00,  0x69,  0x00,  0x65,  0x00,  0x64,  0x00,  0x00,  0x00,
// 0x000A: STR_MISC_SYSTEM_FAMILY:0x000A
  0x14,  0x4E,  0x00,  0x6F,  0x00,  0x74,  0x00,  0x20,  0x00,  0x53,  0x00,  0x70,  0x00,  0x65,  0x00,  0x63,  
  0x00,  0x69,  0x00,  0x66,  0x00,  0x69,  0x00,  0x65,  0x00,  0x64,  0x00,  0x00,  0x00,
// 0x000B: STR_MISC_BASE_BOARD_MANUFACTURER:0x000B
  0x14,  0x4E,  0x00,  0x6F,  0x00,  0x74,  0x00,  0x20,  0x00,  0x53,  0x00,  0x70,  0x00,  0x65,  0x00,  0x63,  
  0x00,  0x69,  0x00,  0x66,  0x00,  0x69,  0x00,  0x65,  0x00,  0x64,  0x00,  0x00,  0x00,
// 0x000C: STR_MISC_BASE_BOARD_PRODUCT_NAME:0x000C
  0x14,  0x4E,  0x00,  0x6F,  0x00,  0x74,  0x00,  0x20,  0x00,  0x53,  0x00,  0x70,  0x00,  0x65,  0x00,  0x63,  
  0x00,  0x69,  0x00,  0x66,  0x00,  0x69,  0x00,  0x65,  0x00,  0x64,  0x00,  0x00,  0x00,
// 0x000D: STR_MISC_BASE_BOARD_VERSION:0x000D
  0x14,  0x4E,  0x00,  0x6F,  0x00,  0x74,  0x00,  0x20,  0x00,  0x53,  0x00,  0x70,  0x00,  0x65,  0x00,  0x63,  
  0x00,  0x69,  0x00,  0x66,  0x00,  0x69,  0x00,  0x65,  0x00,  0x64,  0x00,  0x00,  0x00,
// 0x000E: STR_MISC_BASE_BOARD_SERIAL_NUMBER:0x000E
  0x14,  0x4E,  0x00,  0x6F,  0x00,  0x74,  0x00,  0x20,  0x00,  0x53,  0x00,  0x70,  0x00,  0x65,  0x00,  0x63,  
  0x00,  0x69,  0x00,  0x66,  0x00,  0x69,  0x00,  0x65,  0x00,  0x64,  0x00,  0x00,  0x00,
// 0x000F: STR_MISC_BASE_BOARD_ASSET_TAG:0x000F
  0x14,  0x4E,  0x00,  0x6F,  0x00,  0x74,  0x00,  0x20,  0x00,  0x53,  0x00,  0x70,  0x00,  0x65,  0x00,  0x63,  
  0x00,  0x69,  0x00,  0x66,  0x00,  0x69,  0x00,  0x65,  0x00,  0x64,  0x00,  0x00,  0x00,
// 0x0010: STR_MISC_BASE_BOARD_CHASSIS_LOCATION:0x0010
  0x14,  0x4E,  0x00,  0x6F,  0x00,  0x74,  0x00,  0x20,  0x00,  0x53,  0x00,  0x70,  0x00,  0x65,  0x00,  0x63,  
  0x00,  0x69,  0x00,  0x66,  0x00,  0x69,  0x00,  0x65,  0x00,  0x64,  0x00,  0x00,  0x00,
// 0x0011: STR_MISC_BASE_BOARD_SKU_NUMBER:0x0011
  0x14,  0x4E,  0x00,  0x6F,  0x00,  0x74,  0x00,  0x20,  0x00,  0x53,  0x00,  0x70,  0x00,  0x65,  0x00,  0x63,  
  0x00,  0x69,  0x00,  0x66,  0x00,  0x69,  0x00,  0x65,  0x00,  0x64,  0x00,  0x00,  0x00,
// 0x0012: STR_MISC_CHASSIS_MANUFACTURER:0x0012
  0x14,  0x4E,  0x00,  0x6F,  0x00,  0x74,  0x00,  0x20,  0x00,  0x53,  0x00,  0x70,  0x00,  0x65,  0x00,  0x63,  
  0x00,  0x69,  0x00,  0x66,  0x00,  0x69,  0x00,  0x65,  0x00,  0x64,  0x00,  0x00,  0x00,
// 0x0013: STR_MISC_CHASSIS_VERSION:0x0013
  0x14,  0x4E,  0x00,  0x6F,  0x00,  0x74,  0x00,  0x20,  0x00,  0x53,  0x00,  0x70,  0x00,  0x65,  0x00,  0x63,  
  0x00,  0x69,  0x00,  0x66,  0x00,  0x69,  0x00,  0x65,  0x00,  0x64,  0x00,  0x00,  0x00,
// 0x0014: STR_MISC_CHASSIS_SERIAL_NUMBER:0x0014
  0x14,  0x4E,  0x00,  0x6F,  0x00,  0x74,  0x00,  0x20,  0x00,  0x53,  0x00,  0x70,  0x00,  0x65,  0x00,  0x63,  
  0x00,  0x69,  0x00,  0x66,  0x00,  0x69,  0x00,  0x65,  0x00,  0x64,  0x00,  0x00,  0x00,
// 0x0015: STR_MISC_CHASSIS_ASSET_TAG:0x0015
  0x14,  0x4E,  0x00,  0x6F,  0x00,  0x74,  0x00,  0x20,  0x00,  0x53,  0x00,  0x70,  0x00,  0x65,  0x00,  0x63,  
  0x00,  0x69,  0x00,  0x66,  0x00,  0x69,  0x00,  0x65,  0x00,  0x64,  0x00,  0x00,  0x00,
// 0x0016: STR_MISC_CHASSIS_SKU_NUMBER:0x0016
  0x14,  0x4E,  0x00,  0x6F,  0x00,  0x74,  0x00,  0x20,  0x00,  0x53,  0x00,  0x70,  0x00,  0x65,  0x00,  0x63,  
  0x00,  0x69,  0x00,  0x66,  0x00,  0x69,  0x00,  0x65,  0x00,  0x64,  0x00,  0x00,  0x00,
  0x00,
