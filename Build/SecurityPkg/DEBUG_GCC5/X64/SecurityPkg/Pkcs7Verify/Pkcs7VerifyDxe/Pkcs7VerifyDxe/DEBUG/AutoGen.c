...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xDC952D08, 0xC62B, 0x41c6, {0xBA, 0xC7, 0x70, 0xED, 0x05, 0x4F, 0x91, 0xE5}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "Pkcs7VerifyDxe";
...
{
  return Pkcs7VerifyDriverEntry (ImageHandle, SystemTable);
}
