# 1 "/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/Acpi.c"
...
# 1 "<command-line>" 2
# 1 "/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/Acpi.c"
# 9 "/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/Acpi.c"
...
# 10 "/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/Acpi.c" 2

# 1 "/home/xephyr/Documents/edk2/MdePkg/Include/Guid/Acpi.h" 1
# 36 "/home/xephyr/Documents/edk2/MdePkg/Include/Guid/Acpi.h"
extern EFI_GUID gEfiAcpiTableGuid;
extern EFI_GUID gEfiAcpi10TableGuid;
extern EFI_GUID gEfiAcpi20TableGuid;
# 12 "/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/Acpi.c" 2
# 31 "/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/Acpi.c"
EFI_ACPI_COMMON_HEADER *
ScanTableInSDT (
  EFI_ACPI_DESCRIPTION_HEADER *Sdt,
  UINTN TablePointerSize,
  UINT32 Signature,
  EFI_ACPI_COMMON_HEADER *PreviousTable,
  ...
  )
{
  ...
  if (PreviousTableLocated != ((void *) 0)) {
    do { if (DebugAssertEnabled ()) { if (!(PreviousTable != ((void *) 0))) { UnitTestDebugAssert ("/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/Acpi.c", 47, "PreviousTable != ((void *) 0)"); ; } } } while (((BOOLEAN)(0==1)));
    *PreviousTableLocated = ((BOOLEAN)(0==1));
  } else {
    do { if (DebugAssertEnabled ()) { if (!(PreviousTable == ((void *) 0))) { UnitTestDebugAssert ("/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/Acpi.c", 50, "PreviousTable == ((void *) 0)"); ; } } } while (((BOOLEAN)(0==1)));
  }
  ...
  for (Index = 0; Index < EntryCount; Index ++) {
    ...
    if ((Table != ((void *) 0)) && (Table->Signature == Signature)) {
      if (PreviousTable != ((void *) 0)) {
        if (Table == PreviousTable) {
          *PreviousTableLocated = ((BOOLEAN)(1==1));
...
# 95 "/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/Acpi.c"
EFI_ACPI_COMMON_HEADER *
...
# 128 "/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/Acpi.c"
EFI_ACPI_COMMON_HEADER *
...
# 171 "/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/Acpi.c"
EFI_ACPI_COMMON_HEADER *
  ...
  )
{
  ...
  if (PreviousTableLocated != ((void *) 0)) {
    do { if (DebugAssertEnabled ()) { if (!(PreviousTable != ((void *) 0))) { UnitTestDebugAssert ("/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/Acpi.c", 187, "PreviousTable != ((void *) 0)"); ; } } } while (((BOOLEAN)(0==1)));
    *PreviousTableLocated = ((BOOLEAN)(0==1));
  } else {
    do { if (DebugAssertEnabled ()) { if (!(PreviousTable == ((void *) 0))) { UnitTestDebugAssert ("/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/Acpi.c", 190, "PreviousTable == ((void *) 0)"); ; } } } while (((BOOLEAN)(0==1)));
  }
  ...
  if ((((INTN)(RETURN_STATUS)(Status)) < 0) || (Rsdp == ((void *) 0))) {
    return ((void *) 0);
  }
  ...
  if (Rsdp->Revision >= 0x02) {
    ...
    if (Signature == ((('D') | ('S' << 8)) | ((('D') | ('T' << 8)) << 16))) {
      do { if (DebugAssertEnabled ()) { if (!(PreviousTable == ((void *) 0))) { UnitTestDebugAssert ("/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/Acpi.c", 210, "PreviousTable == ((void *) 0)"); ; } } } while (((BOOLEAN)(0==1)));
    ...
    } else if (Signature == ((('F') | ('A' << 8)) | ((('C') | ('S' << 8)) << 16))) {
      do { if (DebugAssertEnabled ()) { if (!(PreviousTable == ((void *) 0))) { UnitTestDebugAssert ("/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/Acpi.c", 224, "PreviousTable == ((void *) 0)"); ; } } } while (((BOOLEAN)(0==1)));
  ...
  if (Table != ((void *) 0)) {
    return Table;
  } else if ((PreviousTableLocated != ((void *) 0)) &&
              *PreviousTableLocated) {
  ...
  if (Signature == ((('D') | ('S' << 8)) | ((('D') | ('T' << 8)) << 16))) {
    do { if (DebugAssertEnabled ()) { if (!(PreviousTable == ((void *) 0))) { UnitTestDebugAssert ("/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/Acpi.c", 264, "PreviousTable == ((void *) 0)"); ; } } } while (((BOOLEAN)(0==1)));
    ...
    do { if (DebugAssertEnabled ()) { if (!(PreviousTable == ((void *) 0))) { UnitTestDebugAssert ("/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/Acpi.c", 278, "PreviousTable == ((void *) 0)"); ; } } } while (((BOOLEAN)(0==1)));
...
# 339 "/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/Acpi.c"
EFI_ACPI_COMMON_HEADER *
  ...
  )
{
  ...
  if (PreviousTable != ((void *) 0)) {
    if (PreviousTable->Signature != Signature) {
      ...
      return ((void *) 0);
    } else if ((Signature == ((('F') | ('A' << 8)) | ((('C') | ('P' << 8)) << 16))) ||
               (Signature == ((('D') | ('S' << 8)) | ((('D') | ('T' << 8)) << 16))) ||
               (Signature == ((('F') | ('A' << 8)) | ((('C') | ('S' << 8)) << 16)))) {
...
# 415 "/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/Acpi.c"
EFI_ACPI_COMMON_HEADER *
...
{
  return EfiLocateNextAcpiTable (Signature, ((void *) 0));
}
