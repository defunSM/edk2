...
.Ltext0:
	...
	.globl	gImageHandle
	.section	.bss.gImageHandle,"aw",@nobits
	.align	3
	.type	gImageHandle, @object
	.size	gImageHandle, 8
gImageHandle:
	.zero	8
	.globl	gST
	.section	.bss.gST,"aw",@nobits
	.align	3
	.type	gST, @object
	.size	gST, 8
gST:
...
gBS:
	...
	.align	3
.LC0:
	.string	"gImageHandle != ((void *) 0)"
	.align	3
.LC1:
	.string	"/home/xephyr/Documents/edk2/MdePkg/Library/UefiBootServicesTableLib/UefiBootServicesTableLib.c"
	.align	3
.LC2:
	.string	"gST != ((void *) 0)"
	.align	3
.LC3:
	.string	"gBS != ((void *) 0)"
	.section	.text.UefiBootServicesTableLibConstructor,"ax",@progbits
	.align	1
	.globl	UefiBootServicesTableLibConstructor
	.type	UefiBootServicesTableLibConstructor, @function
UefiBootServicesTableLibConstructor:
.LFB0:
	.file 1 "/home/xephyr/Documents/edk2/MdePkg/Library/UefiBootServicesTableLib/UefiBootServicesTableLib.c"
	.loc 1 40 1
	.cfi_startproc
	addi	sp,sp,-32
...
.L2:
	...
	.loc 1 51 11
	beq	a5,zero,.L3
	.loc 1 51 41 discriminator 1
	lla	a5,gST
	ld	a5,0(a5)
	.loc 1 51 40 discriminator 1
	bne	a5,zero,.L3
	.loc 1 51 67 discriminator 2
	lla	a2,.LC2
	li	a1,51
	lla	a0,.LC1
	call	UnitTestDebugAssert
...
.L4:
	...
	.cfi_endproc
.LFE0:
	.size	UefiBootServicesTableLibConstructor, .-UefiBootServicesTableLibConstructor
	.text
.Letext0:
	...
	.file 14 "/home/xephyr/Documents/edk2/Build/Mde/RELEASE_GCC5/RISCV64/MdePkg/Library/UefiBootServicesTableLib/UefiBootServicesTableLib/DEBUG/AutoGen.h"
...
.LASF301:
	.string	"/home/xephyr/Documents/edk2/Build/Mde/RELEASE_GCC5/RISCV64/MdePkg/Library/UefiBootServicesTableLib/UefiBootServicesTableLib"
.LASF214:
...
.LASF302:
	.string	"UefiBootServicesTableLibConstructor"
.LASF18:
	.string	"Data1"
.LASF19:
	.string	"Data2"
