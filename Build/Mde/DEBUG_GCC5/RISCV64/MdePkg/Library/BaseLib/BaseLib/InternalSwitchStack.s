...
.Ltext0:
	...
	.align	3
.LC0:
	.string	"RISC-V InternalSwitchStack Entry:%x Context1:%x Context2:%x NewStack%x\n"
	.align	3
.LC1:
	.string	"((BOOLEAN)(0==1))"
	.align	3
.LC2:
	.string	"/home/xephyr/Documents/edk2/MdePkg/Library/BaseLib/RiscV64/InternalSwitchStack.c"
	.section	.text.InternalSwitchStack,"ax",@progbits
	.align	1
	.globl	InternalSwitchStack
	.type	InternalSwitchStack, @function
InternalSwitchStack:
.LFB0:
	.file 1 "/home/xephyr/Documents/edk2/MdePkg/Library/BaseLib/RiscV64/InternalSwitchStack.c"
	.loc 1 44 1
	.cfi_startproc
	addi	sp,sp,-176
