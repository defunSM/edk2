...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x6e881000, 0x5749, 0x11e8, {0x9b, 0xf0, 0x8c, 0xdc, 0xd4, 0x26, 0xc9, 0x73}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "RedfishConfigHandlerDriver";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEdkIIRedfishCredentialProtocolGuid = { 0x8804377, 0xaf7a, 0x4496, { 0x8a, 0x7b, 0x17, 0x59, 0x0, 0xe9, 0xab, 0x46 } };
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEdkIIRedfishConfigHandlerProtocolGuid = { 0xbc0fe6bb, 0x2cc9, 0x463e, { 0x90, 0x82, 0xfa, 0x11, 0x76, 0xfc, 0x67, 0xde } };
...
{
  return RedfishConfigHandlerDriverEntryPoint (ImageHandle, SystemTable);
}
...
{
  return RedfishConfigHandlerDriverUnload (ImageHandle);
}
