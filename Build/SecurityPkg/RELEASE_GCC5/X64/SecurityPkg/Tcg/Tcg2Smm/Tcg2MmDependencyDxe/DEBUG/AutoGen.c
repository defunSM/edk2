...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x94C210EA, 0x3113, 0x4563, {0xAD, 0xEB, 0x76, 0xFE, 0x75, 0x9C, 0x2F, 0x46}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "Tcg2MmDependencyDxe";
...
{
  return Tcg2MmDependencyDxeEntryPoint (ImageHandle, SystemTable);
}
