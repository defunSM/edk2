...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x0bda00b0, 0x05d6, 0x4bb8, {0xbf, 0xc7, 0x05, 0x8a, 0xd1, 0x36, 0x15, 0xcf}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "ArmCrashDumpDxe";
...
{
  return ArmCrashDumpDxeInitialize (ImageHandle, SystemTable);
}
