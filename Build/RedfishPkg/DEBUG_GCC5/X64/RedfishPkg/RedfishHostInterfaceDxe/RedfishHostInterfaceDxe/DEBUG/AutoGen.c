...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x592626DA, 0x4A1E, 0x8B39, {0x28, 0xBA, 0xFE, 0xAD, 0x92, 0xC4, 0xA0, 0xA4}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "RedfishHostInterfaceDxe";
...
{
  return RedfishHostInterfaceDxeEntryPoint (ImageHandle, SystemTable);
}
