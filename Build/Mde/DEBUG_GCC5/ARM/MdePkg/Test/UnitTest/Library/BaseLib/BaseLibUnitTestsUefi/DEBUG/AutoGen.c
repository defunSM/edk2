...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xdf5a6fed, 0x8786, 0x4a9d, {0x9d, 0x02, 0xea, 0xb3, 0x94, 0x97, 0xb4, 0xa1}};

GLOBAL_REMOVE_IF_UNREFERENCED GUID gEdkiiDscPlatformGuid = {0x082F8BFC, 0x0455, 0x4859, {0xAE, 0x3C, 0xEC, 0xD6, 0x4F, 0xB8, 0x16, 0x42}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "BaseLibUnitTestsUefi";
...
#define _PCD_TOKEN_PcdMaximumAsciiStringLength  12U
...
#define _PCD_TOKEN_PcdUnitTestLogLevel  30U
...
#define _PCD_TOKEN_PcdFixedDebugPrintErrorLevel  10U
...
{
  return BaseLibUnitTestAppEntry (ImageHandle, SystemTable);
}
