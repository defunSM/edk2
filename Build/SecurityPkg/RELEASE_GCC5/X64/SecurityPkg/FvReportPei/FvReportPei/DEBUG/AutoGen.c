...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x72405B40, 0x38DA, 0x4ABA, {0x92, 0x83, 0xCA, 0x83, 0x21, 0xC2, 0x3E, 0x63}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "FvReportPei";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEdkiiPeiFirmwareVolumeInfoStoredHashFvPpiGuid = {0x7f5e4e31, 0x81b1, 0x47e5, { 0x9e, 0x21, 0x1e, 0x4b, 0x5b, 0xc2, 0xf6, 0x1d } };
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdStatusCodeFvVerificationPass = _PCD_VALUE_PcdStatusCodeFvVerificationPass;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdStatusCodeFvVerificationFail = _PCD_VALUE_PcdStatusCodeFvVerificationFail;
...
{
  return FvReportEntryPoint (FileHandle, PeiServices);
}
