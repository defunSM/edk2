...
.LFB0:
	.file 1 "/home/xephyr/Documents/edk2/MdePkg/Library/BasePciLibCf8/PciLib.c"
	.loc 1 42 1
	.cfi_startproc
	addi	sp,sp,-32
	...
	.loc 1 43 10
	ld	a0,-24(s0)
	call	PciCf8RegisterForRuntimeAccess
	mv	a5,a0
	.loc 1 44 1
	mv	a0,a5
	ld	ra,24(sp)
...
.LFB20:
	...
	ld	a1,-32(s0)
	ld	a0,-24(s0)
	call	PciCf8BitFieldAndThenOr16
	mv	a5,a0
	.loc 1 720 1
	mv	a0,a5
	ld	ra,40(sp)
...
.LFB30:
	...
	ld	a1,-32(s0)
	ld	a0,-24(s0)
	call	PciCf8BitFieldAndThenOr32
	mv	a5,a0
	sext.w	a5,a5
	.loc 1 1063 1
	mv	a0,a5
...
.Letext0:
	...
	.file 4 "/home/xephyr/Documents/edk2/Build/Mde/DEBUG_GCC5/RISCV64/MdePkg/Library/BasePciLibCf8/BasePciLibCf8/DEBUG/AutoGen.h"
...
.LASF25:
	.string	"Size"
.LASF66:
	.string	"/home/xephyr/Documents/edk2/MdePkg/Library/BasePciLibCf8/PciLib.c"
.LASF58:
...
.LASF9:
	.string	"UINT8"
.LASF67:
	.string	"/home/xephyr/Documents/edk2/Build/Mde/DEBUG_GCC5/RISCV64/MdePkg/Library/BasePciLibCf8/BasePciLibCf8"
.LASF34:
	.string	"OrData"
.LASF21:
