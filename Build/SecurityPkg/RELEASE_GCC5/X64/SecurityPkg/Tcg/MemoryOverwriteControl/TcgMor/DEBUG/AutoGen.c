...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xAD416CE3, 0xA483, 0x45b1, {0x94, 0xC2, 0x4B, 0x4E, 0x4D, 0x57, 0x55, 0x62}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "TcgMor";
...
{
  return MorDriverEntryPoint (ImageHandle, SystemTable);
}
