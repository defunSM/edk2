...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x1C8B7F78, 0x1699, 0x40e6, {0xAF, 0x33, 0x9B, 0x99, 0x5D, 0x16, 0xB0, 0x43}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "PiSmmCommunicationPei";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gPeiSmmControlPpiGuid = { 0x61c68702, 0x4d7e, 0x4f43, { 0x8d, 0xef, 0xa7, 0x43, 0x5, 0xce, 0x74, 0xc5 }};
...
{
  return PiSmmCommunicationPeiEntryPoint (FileHandle, PeiServices);
}
