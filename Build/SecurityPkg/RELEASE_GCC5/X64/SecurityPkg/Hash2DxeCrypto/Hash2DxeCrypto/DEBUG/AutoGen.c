...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x63E3BDCF, 0x2AC7, 0x4ac0, {0x9B, 0x92, 0x03, 0xA7, 0x54, 0x14, 0x22, 0xFF}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "Hash2DxeCrypto";
...
#define _PCD_TOKEN_PcdDebugPrintErrorLevel  14U
...
#define _PCD_TOKEN_PcdDebugClearMemoryValue  13U
...
#define _PCD_TOKEN_PcdDebugPropertyMask  15U
...
#define _PCD_TOKEN_PcdFixedDebugPrintErrorLevel  18U
...
{
  return Hash2DriverEntryPoint (ImageHandle, SystemTable);
}
