...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x1d005f4c, 0x4dfa, 0x41b5, {0xab, 0x0c, 0xbe, 0x91, 0xfe, 0x12, 0x14, 0x59}};

GLOBAL_REMOVE_IF_UNREFERENCED GUID gEdkiiDscPlatformGuid = {0x50652B4C, 0x88CB, 0x4481, {0x96, 0xE8, 0x37, 0xF2, 0xD0, 0x03, 0x44, 0x40}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "BaseLibUnitTestsHost";
