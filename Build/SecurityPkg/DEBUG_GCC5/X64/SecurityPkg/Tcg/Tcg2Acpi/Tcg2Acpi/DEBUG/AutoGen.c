...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x0D4BBF18, 0xC2CC, 0x4C23, {0xBD, 0x63, 0xBF, 0xDA, 0xD4, 0xC7, 0x10, 0xD0}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "Tcg2Acpi";
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT16 _gPcd_FixedAtBuild_PcdSmiCommandIoPort = _PCD_VALUE_PcdSmiCommandIoPort;
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdTpm2CurrentIrqNum = _PCD_VALUE_PcdTpm2CurrentIrqNum;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT8 _gPcd_FixedAtBuild_PcdTpm2PossibleIrqNumBuf[4] = {0x00, 0x00, 0x00, 0x00};
GLOBAL_REMOVE_IF_UNREFERENCED const UINTN _gPcd_FixedAtBuild_Size_PcdTpm2PossibleIrqNumBuf = 4;
...
{
  return InitializeTcgAcpi (ImageHandle, SystemTable);
}
