...
.LFB0:
	.file 1 "/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/UefiNotTiano.c"
	.loc 1 40 1
	.cfi_startproc
	addi	sp,sp,-32
...
.LFE0:
	...
	.align	3
.LC0:
	.string	"LegacyBootEvent != ((void *) 0)"
	.align	3
.LC1:
	.string	"/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/UefiNotTiano.c"
	.align	3
.LC2:
	.string	"EFI1.1 can't support LegacyBootEvent!"
	.align	3
.LC3:
	.string	"((BOOLEAN)(0==1))"
...
.L10:
	...
	.loc 1 100 14
	ld	a5,-64(s0)
	lla	a4,gEfiEventLegacyBootGuid
	ld	a3,-56(s0)
	ld	a2,-24(s0)
	ld	a1,-40(s0)
	li	a0,512
...
.LFE2:
	...
	.align	3
.LC4:
	.string	"ReadyToBootEvent != ((void *) 0)"
	.align	3
.LC5:
	.string	"EFI1.1 can't support ReadyToBootEvent!"
...
.L14:
	...
	call	DebugPrintLevelEnabled
	mv	a5,a0
	.loc 1 178 46 discriminator 1
	beq	a5,zero,.L16
	.loc 1 178 86 discriminator 2
	lla	a1,.LC5
	li	a5,1
	slli	a0,a5,31
	call	DebugPrint
...
.L20:
	...
	.loc 1 195 14
	ld	a5,-64(s0)
	lla	a4,gEfiEventReadyToBootGuid
	ld	a3,-56(s0)
	ld	a2,-24(s0)
	ld	a1,-40(s0)
	li	a0,512
...
.LFE5:
	...
	.align	3
.LC6:
	.string	"FvDevicePathNode != ((void *) 0)"
...
.L28:
	...
	li	a5,4
	bne	a4,a5,.L29
	.loc 1 287 26 discriminator 1
	ld	a5,-24(s0)
	.loc 1 287 7 discriminator 1
	mv	a0,a5
	call	DevicePathSubType
	mv	a5,a0
	.loc 1 286 58 discriminator 1
	mv	a4,a5
	li	a5,6
	bne	a4,a5,.L29
	.loc 1 288 12
...
.LFB7:
	...
	.loc 1 318 11
	beq	a5,zero,.L32
	.loc 1 318 40 discriminator 1
	ld	a5,-24(s0)
	bne	a5,zero,.L32
	.loc 1 318 80 discriminator 2
	lla	a2,.LC6
	li	a1,318
	lla	a0,.LC1
	call	UnitTestDebugAssert
