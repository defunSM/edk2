...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x22ea234f, 0xe72a, 0x11e4, {0x91, 0xf9, 0x28, 0xd2, 0x44, 0x7c, 0x48, 0x29}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "HttpUtilitiesDxe";
...
{
  return HttpUtilitiesDxeDriverEntryPoint (ImageHandle, SystemTable);
}
...
{
  return HttpUtilitiesDxeUnload (ImageHandle);
}
