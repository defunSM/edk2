# 1 "/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/UefiLibPrint.c"
...
# 1 "<command-line>" 2
# 1 "/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/UefiLibPrint.c"
# 10 "/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/UefiLibPrint.c"
...
# 11 "/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/UefiLibPrint.c" 2
...
# 49 "/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/UefiLibPrint.c"
UINTN
InternalPrint (
  const CHAR16 *Format,
  ...
  )
{
  ...
  do { if (DebugAssertEnabled ()) { if (!(Format != ((void *) 0))) { UnitTestDebugAssert ("/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/UefiLibPrint.c", 61, "Format != ((void *) 0)"); ; } } } while (((BOOLEAN)(0==1)));
  do { if (DebugAssertEnabled ()) { if (!(((UINTN) Format & 0x00000001) == 0)) { UnitTestDebugAssert ("/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/UefiLibPrint.c", 62, "((UINTN) Format & 0x00000001) == 0"); ; } } } while (((BOOLEAN)(0==1)));
  do { if (DebugAssertEnabled ()) { if (!(Console != ((void *) 0))) { UnitTestDebugAssert ("/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/UefiLibPrint.c", 63, "Console != ((void *) 0)"); ; } } } while (((BOOLEAN)(0==1)));

  BufferSize = (_gPcd_FixedAtBuild_PcdUefiLibMaxPrintBufferSize + 1) * sizeof (CHAR16);

  Buffer = (CHAR16 *) AllocatePool(BufferSize);
  do { if (DebugAssertEnabled ()) { if (!(Buffer != ((void *) 0))) { UnitTestDebugAssert ("/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/UefiLibPrint.c", 68, "Buffer != ((void *) 0)"); ; } } } while (((BOOLEAN)(0==1)));

  Return = UnicodeVSPrint (Buffer, BufferSize, Format, Marker);

  if (Console != ((void *) 0) && Return > 0) {
...
# 107 "/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/UefiLibPrint.c"
UINTN
...
# 146 "/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/UefiLibPrint.c"
UINTN
...
# 185 "/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/UefiLibPrint.c"
UINTN
AsciiInternalPrint (
  const CHAR8 *Format,
  EFI_SIMPLE_TEXT_OUTPUT_PROTOCOL *Console,
  ...
  )
{
  ...
  do { if (DebugAssertEnabled ()) { if (!(Format != ((void *) 0))) { UnitTestDebugAssert ("/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/UefiLibPrint.c", 197, "Format != ((void *) 0)"); ; } } } while (((BOOLEAN)(0==1)));
  do { if (DebugAssertEnabled ()) { if (!(Console != ((void *) 0))) { UnitTestDebugAssert ("/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/UefiLibPrint.c", 198, "Console != ((void *) 0)"); ; } } } while (((BOOLEAN)(0==1)));

  BufferSize = (_gPcd_FixedAtBuild_PcdUefiLibMaxPrintBufferSize + 1) * sizeof (CHAR16);

  Buffer = (CHAR16 *) AllocatePool(BufferSize);
  do { if (DebugAssertEnabled ()) { if (!(Buffer != ((void *) 0))) { UnitTestDebugAssert ("/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/UefiLibPrint.c", 203, "Buffer != ((void *) 0)"); ; } } } while (((BOOLEAN)(0==1)));
...
# 241 "/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/UefiLibPrint.c"
UINTN
  ...
  )
{
  VA_LIST Marker;
  UINTN Return;
  do { if (DebugAssertEnabled ()) { if (!(Format != ((void *) 0))) { UnitTestDebugAssert ("/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/UefiLibPrint.c", 250, "Format != ((void *) 0)"); ; } } } while (((BOOLEAN)(0==1)));
...
# 280 "/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/UefiLibPrint.c"
UINTN
  ...
  )
{
  ...
  do { if (DebugAssertEnabled ()) { if (!(Format != ((void *) 0))) { UnitTestDebugAssert ("/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/UefiLibPrint.c", 290, "Format != ((void *) 0)"); ; } } } while (((BOOLEAN)(0==1)));
...
# 334 "/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/UefiLibPrint.c"
UINTN
  ...
  )
{
  ...
  do { if (DebugAssertEnabled ()) { if (!(ConsoleHandle != ((void *) 0))) { UnitTestDebugAssert ("/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/UefiLibPrint.c", 369, "ConsoleHandle != ((void *) 0)"); ; } } } while (((BOOLEAN)(0==1)));
  ...
  UgaDraw = ((void *) 0);
  if ((((INTN)(RETURN_STATUS)(Status)) < 0) && _gPcd_FixedAtBuild_PcdUgaConsumeSupport) {
  ...
  } else if (UgaDraw != ((void *) 0) && _gPcd_FixedAtBuild_PcdUgaConsumeSupport) {
    UgaDraw->GetMode (UgaDraw, &HorizontalResolution, &VerticalResolution, &ColorDepth, &RefreshRate);
  } else {
    goto Error;
  }

  do { if (DebugAssertEnabled ()) { if (!((HorizontalResolution != 0) && (VerticalResolution !=0))) { UnitTestDebugAssert ("/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/UefiLibPrint.c", 413, "(HorizontalResolution != 0) && (VerticalResolution !=0)"); ; } } } while (((BOOLEAN)(0==1)));

  Status = gBS->LocateProtocol (&gEfiHiiFontProtocolGuid, ((void *) 0), (void **) &HiiFont);
  if ((((INTN)(RETURN_STATUS)(Status)) < 0)) {
    goto Error;
  }

  Blt = (EFI_IMAGE_OUTPUT *) AllocateZeroPool (sizeof (EFI_IMAGE_OUTPUT));
  do { if (DebugAssertEnabled ()) { if (!(Blt != ((void *) 0))) { UnitTestDebugAssert ("/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/UefiLibPrint.c", 421, "Blt != ((void *) 0)"); ; } } } while (((BOOLEAN)(0==1)));
  ...
  if (GraphicsOutput != ((void *) 0)) {
  ...
  } else if (_gPcd_FixedAtBuild_PcdUgaConsumeSupport) {
    do { if (DebugAssertEnabled ()) { if (!(UgaDraw!= ((void *) 0))) { UnitTestDebugAssert ("/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/UefiLibPrint.c", 469, "UgaDraw!= ((void *) 0)"); ; } } } while (((BOOLEAN)(0==1)));




    if (Blt->Width > DivU64x32 (((UINTN)0xFFFFFFFFFFFFFFFFULL), Blt->Height * sizeof (EFI_GRAPHICS_OUTPUT_BLT_PIXEL))) {
      goto Error;
    }

    Blt->Image.Bitmap = AllocateZeroPool ((UINT32) Blt->Width * Blt->Height * sizeof (EFI_GRAPHICS_OUTPUT_BLT_PIXEL));
    do { if (DebugAssertEnabled ()) { if (!(Blt->Image.Bitmap != ((void *) 0))) { UnitTestDebugAssert ("/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/UefiLibPrint.c", 479, "Blt->Image.Bitmap != ((void *) 0)"); ; } } } while (((BOOLEAN)(0==1)));
    ...
    if (!(((INTN)(RETURN_STATUS)(Status)) < 0)) {
      do { if (DebugAssertEnabled ()) { if (!(RowInfoArray != ((void *) 0))) { UnitTestDebugAssert ("/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/UefiLibPrint.c", 501, "RowInfoArray != ((void *) 0)"); ; } } } while (((BOOLEAN)(0==1)));




      do { if (DebugAssertEnabled ()) { if (!(RowInfoArraySize <= 1)) { UnitTestDebugAssert ("/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/UefiLibPrint.c", 506, "RowInfoArraySize <= 1"); ; } } } while (((BOOLEAN)(0==1)));
...
# 598 "/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/UefiLibPrint.c"
UINTN
  ...
  )
{
  ...
  do { if (DebugAssertEnabled ()) { if (!(Format != ((void *) 0))) { UnitTestDebugAssert ("/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/UefiLibPrint.c", 615, "Format != ((void *) 0)"); ; } } } while (((BOOLEAN)(0==1)));
  do { if (DebugAssertEnabled ()) { if (!(((UINTN) Format & 0x00000001) == 0)) { UnitTestDebugAssert ("/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/UefiLibPrint.c", 616, "((UINTN) Format & 0x00000001) == 0"); ; } } } while (((BOOLEAN)(0==1)));
  ...
  Buffer = (CHAR16 *) AllocatePool (BufferSize);
  do { if (DebugAssertEnabled ()) { if (!(Buffer != ((void *) 0))) { UnitTestDebugAssert ("/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/UefiLibPrint.c", 623, "Buffer != ((void *) 0)"); ; } } } while (((BOOLEAN)(0==1)));
...
# 677 "/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/UefiLibPrint.c"
UINTN
  ...
  )
{
  ...
  do { if (DebugAssertEnabled ()) { if (!(Format != ((void *) 0))) { UnitTestDebugAssert ("/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/UefiLibPrint.c", 694, "Format != ((void *) 0)"); ; } } } while (((BOOLEAN)(0==1)));
  ...
  Buffer = (CHAR16 *) AllocatePool (BufferSize);
  do { if (DebugAssertEnabled ()) { if (!(Buffer != ((void *) 0))) { UnitTestDebugAssert ("/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/UefiLibPrint.c", 701, "Buffer != ((void *) 0)"); ; } } } while (((BOOLEAN)(0==1)));
...
# 735 "/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/UefiLibPrint.c"
CHAR16*
  ...
  )
{
  ...
  __builtin_va_copy (ExtraMarker, Marker);
  CharactersRequired = SPrintLength(FormatString, ExtraMarker);
  __builtin_va_end (ExtraMarker);
  ...
  do { if (DebugAssertEnabled ()) { if (!(StrSize(BufferToReturn)==SizeRequired)) { UnitTestDebugAssert ("/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/UefiLibPrint.c", 772, "StrSize(BufferToReturn)==SizeRequired"); ; } } } while (((BOOLEAN)(0==1)));

  return (BufferToReturn);
}
# 800 "/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/UefiLibPrint.c"
CHAR16 *
