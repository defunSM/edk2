...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x58B35361, 0x8922, 0x41BC, {0xB3, 0x13, 0xEF, 0x7E, 0xD9, 0xAD, 0xFD, 0xF7}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "SecMigrationPei";
...
{
  return SecMigrationPeiInitialize (FileHandle, PeiServices);
}
