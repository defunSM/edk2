# 1 "/home/xephyr/Documents/edk2/MdePkg/Library/PeiSmbusLibSmbus2Ppi/PeiSmbusLib.c"
...
# 1 "<command-line>" 2
# 1 "/home/xephyr/Documents/edk2/MdePkg/Library/PeiSmbusLibSmbus2Ppi/PeiSmbusLib.c"
# 9 "/home/xephyr/Documents/edk2/MdePkg/Library/PeiSmbusLibSmbus2Ppi/PeiSmbusLib.c"
...
# 10 "/home/xephyr/Documents/edk2/MdePkg/Library/PeiSmbusLibSmbus2Ppi/PeiSmbusLib.c" 2
# 21 "/home/xephyr/Documents/edk2/MdePkg/Library/PeiSmbusLibSmbus2Ppi/PeiSmbusLib.c"
EFI_PEI_SMBUS2_PPI *
InternalGetSmbusPpi (
  void
  )
{
  ...
  Status = PeiServicesLocatePpi (&gEfiPeiSmbus2PpiGuid, 0, ((void *) 0), (void **) &SmbusPpi);
  do { if (DebugAssertEnabled ()) { if ((((INTN)(RETURN_STATUS)(Status)) < 0)) { do { if (DebugPrintEnabled ()) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "\nASSERT_EFI_ERROR (Status = %r)\n", Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1))); UnitTestDebugAssert ("/home/xephyr/Documents/edk2/MdePkg/Library/PeiSmbusLibSmbus2Ppi/PeiSmbusLib.c", 30, "!EFI_ERROR (Status)"); } } } while (((BOOLEAN)(0==1)));
  do { if (DebugAssertEnabled ()) { if (!(SmbusPpi != ((void *) 0))) { UnitTestDebugAssert ("/home/xephyr/Documents/edk2/MdePkg/Library/PeiSmbusLibSmbus2Ppi/PeiSmbusLib.c", 31, "SmbusPpi != ((void *) 0)"); ; } } } while (((BOOLEAN)(0==1)));

  return SmbusPpi;
}
# 59 "/home/xephyr/Documents/edk2/MdePkg/Library/PeiSmbusLibSmbus2Ppi/PeiSmbusLib.c"
UINTN
InternalSmBusExec (
  EFI_SMBUS_OPERATION SmbusOperation,
  UINTN SmBusAddress,
  ...
  )
{
  ...
  SmbusDeviceAddress.SmbusDeviceAddress = (((SmBusAddress) >> 1) & 0x7f);
  ...
  ReturnStatus = SmbusPpi->Execute (
                             ...
                             (((SmBusAddress) >> 8) & 0xff),
                             SmbusOperation,
                             ((BOOLEAN) (((SmBusAddress) & 0x00400000) != 0)),
                             &Length,
                             Buffer
                             );
  if (Status != ((void *) 0)) {
