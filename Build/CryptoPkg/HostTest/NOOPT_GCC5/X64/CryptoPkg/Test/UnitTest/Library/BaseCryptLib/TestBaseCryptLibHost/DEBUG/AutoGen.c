...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x0cb84598, 0x824b, 0x4833, {0xb7, 0x05, 0xbd, 0xef, 0xdc, 0xbb, 0xa1, 0xd5}};

GLOBAL_REMOVE_IF_UNREFERENCED GUID gEdkiiDscPlatformGuid = {0xC7F97D6D, 0x54AC, 0x45A9, {0x81, 0x97, 0xCC, 0x99, 0xB2, 0x0C, 0xC7, 0xEC}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "BaseCryptLibUnitTestHost";
