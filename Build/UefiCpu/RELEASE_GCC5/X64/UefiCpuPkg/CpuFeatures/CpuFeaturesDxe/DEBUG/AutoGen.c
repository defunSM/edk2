...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x63EB1B62, 0x10C9, 0x4693, {0x88, 0xAC, 0xAE, 0x09, 0x99, 0xEA, 0x87, 0xF8}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "CpuFeaturesDxe";
...
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_PcdCpuFeaturesInitAfterSmmRelocation = _PCD_VALUE_PcdCpuFeaturesInitAfterSmmRelocation;
...
{
  return CpuFeaturesDxeInitialize (ImageHandle, SystemTable);
}
