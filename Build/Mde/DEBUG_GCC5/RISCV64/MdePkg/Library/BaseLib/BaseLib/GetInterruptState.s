...
.Ltext0:
	...
	.section	.text.GetInterruptState,"ax",@progbits
	.align	1
	.globl	GetInterruptState
	.type	GetInterruptState, @function
GetInterruptState:
.LFB0:
	.file 1 "/home/xephyr/Documents/edk2/MdePkg/Library/BaseLib/RiscV64/GetInterruptState.c"
	.loc 1 28 1
	.cfi_startproc
	addi	sp,sp,-32
	...
	.cfi_def_cfa 8, 0
	.loc 1 31 14
	call	RiscVGetSupervisorModeInterrupts
	mv	a5,a0
	sext.w	a5,a5
	.loc 1 31 12
	slli	a5,a5,32
	...
	.cfi_endproc
.LFE0:
	.size	GetInterruptState, .-GetInterruptState
	.text
.Letext0:
...
.LASF10:
	.string	"UINT8"
.LASF31:
	.string	"/home/xephyr/Documents/edk2/MdePkg/Library/BaseLib/RiscV64/GetInterruptState.c"
.LASF20:
