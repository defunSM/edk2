# 1 "/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/Console.c"
...
# 1 "<command-line>" 2
# 1 "/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/Console.c"
# 12 "/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/Console.c"
...
# 13 "/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/Console.c" 2
...
typedef struct {
 ...
 const UNICODE_WIDTH_ENTRY mUnicodeWidthTable[] = {



  {(CHAR16)0x1FFF, 1},
# 73 "/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/Console.c"
  {(CHAR16)0x2FFF, 1},
# 105 "/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/Console.c"
  {(CHAR16)0x33FF, 2},
# 128 "/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/Console.c"
  {(CHAR16)0x9FFF, 2},
# 145 "/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/Console.c"
  {(CHAR16)0xABFF, 0},
  ...
  {(CHAR16)0xD7FF, 2},
# 166 "/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/Console.c"
  {(CHAR16)0xDFFF, 0},
...
# 201 "/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/Console.c"
UINTN
...
# 261 "/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/Console.c"
UINTN
...
# 305 "/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/Console.c"
UINTN
  ...
  )
{
  ...
  do {
    ...
    for (;(String[Index] != 0xFFF0) && (String[Index] != 0xFFF1) && (String[Index] != 0); Index++) {
...
# 389 "/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/Console.c"
void
  ...
  )
{
  ...
  __builtin_va_start (Args, Key);
  MaxLength = 0;
  NumberOfLines = 0;
  while ((String = ((sizeof (CHAR16 *) < sizeof (UINTN)) ? (CHAR16 *)(__builtin_va_arg (Args, UINTN)) : (CHAR16 *)(__builtin_va_arg (Args, CHAR16 *)))) != ((void *) 0)) {
    MaxLength = (((MaxLength) > (UefiLibGetStringWidth (String, ((BOOLEAN)(0==1)), 0, ((void *) 0)) / 2)) ? (MaxLength) : (UefiLibGetStringWidth (String, ((BOOLEAN)(0==1)), 0, ((void *) 0)) / 2));
    NumberOfLines++;
  }
  ...
  do { if (DebugAssertEnabled ()) { if (!(NumberOfLines != 0)) { UnitTestDebugAssert ("/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/Console.c", 429, "NumberOfLines != 0"); ; } } } while (((BOOLEAN)(0==1)));




  do { if (DebugAssertEnabled ()) { if (!(MaxLength != 0)) { UnitTestDebugAssert ("/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/Console.c", 434, "MaxLength != 0"); ; } } } while (((BOOLEAN)(0==1)));
  ...
  ConOut->EnableCursor (ConOut, ((BOOLEAN)(0==1)));
  ConOut->SetAttribute (ConOut, Attribute);




  NumberOfLines = (((NumberOfLines) < (Rows - 3)) ? (NumberOfLines) : (Rows - 3));




  MaxLength = (((MaxLength) < (Columns - 2)) ? (MaxLength) : (Columns - 2));
  ...
  do { if (DebugAssertEnabled ()) { if (!(Line != ((void *) 0))) { UnitTestDebugAssert ("/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/Console.c", 477, "Line != ((void *) 0)"); ; } } } while (((BOOLEAN)(0==1)));




  SetMem16 (Line, (MaxLength + 2) * 2, 0x2500);
  Line[0] = 0x250c;
  Line[MaxLength + 1] = 0x2510;
  ...
  __builtin_va_start (Args, Key);
  while ((String = ((sizeof (CHAR16 *) < sizeof (UINTN)) ? (CHAR16 *)(__builtin_va_arg (Args, UINTN)) : (CHAR16 *)(__builtin_va_arg (Args, CHAR16 *)))) != ((void *) 0) && NumberOfLines > 0) {
    SetMem16 (Line, (MaxLength + 2) * 2, L' ');
    Line[0] = 0x2502;
    Line[MaxLength + 1] = 0x2502;
    Line[MaxLength + 2] = L'\0';
    ConOut->SetCursorPosition (ConOut, Column, Row);
    ConOut->OutputString (ConOut, Line);
    Length = UefiLibGetStringWidth (String, ((BOOLEAN)(0==1)), 0, ((void *) 0)) / 2;
    if (Length <= MaxLength) {
      ...
      UefiLibGetStringWidth (String, ((BOOLEAN)(1==1)), MaxLength, &Length);
      TmpString = AllocateZeroPool ((Length + 1) * sizeof (CHAR16));
      do { if (DebugAssertEnabled ()) { if (!(TmpString != ((void *) 0))) { UnitTestDebugAssert ("/home/xephyr/Documents/edk2/MdePkg/Library/UefiLib/Console.c", 513, "TmpString != ((void *) 0)"); ; } } } while (((BOOLEAN)(0==1)));
  ...
  if (Key != ((void *) 0)) {
    while (((BOOLEAN)(1==1))) {
      ...
      if (Status != ((RETURN_STATUS)(0x8000000000000000ULL | (6)))) {
        continue;
      }
