...
.Ltext0:
	...
	.align	3
.LC0:
	.string	"%a: Buffer == NULL.\n"
	.align	3
.LC1:
	.string	"%a: Could not locate RNG prototocol, Status = %r\n"
	.align	3
.LC2:
	.string	"%a: GetRNG algorithm CTR-256 - Status = %r\n"
	.align	3
.LC3:
	.string	"%a: GetRNG algorithm HMAC-256 - Status = %r\n"
	.align	3
.LC4:
	.string	"%a: GetRNG algorithm Hash-256 - Status = %r\n"
	.align	3
.LC5:
	.string	"%a: GetRNG() failed, staus = %r\n"
	.section	.text.GenerateRandomNumberViaNist800Algorithm,"ax",@progbits
	.align	1
	.type	GenerateRandomNumberViaNist800Algorithm, @function
GenerateRandomNumberViaNist800Algorithm:
.LFB0:
	.file 1 "/home/xephyr/Documents/edk2/MdePkg/Library/DxeRngLib/DxeRngLib.c"
	.loc 1 33 1
	.cfi_startproc
	addi	sp,sp,-48
	...
	.loc 1 40 15
	beq	a5,zero,.L3
	.loc 1 40 49 discriminator 1
	li	a5,1
	slli	a0,a5,31
	call	DebugPrintLevelEnabled
	mv	a5,a0
	.loc 1 40 48 discriminator 1
	beq	a5,zero,.L3
	.loc 1 40 88 discriminator 2
	lla	a2,__FUNCTION__.8243
	lla	a1,.LC0
	li	a5,1
	slli	a0,a5,31
	call	DebugPrint
...
.L6:
	...
	ld	a3,-40(s0)
	ld	a2,-48(s0)
	lla	a1,gEfiRngAlgorithmSp80090Ctr256Guid
	mv	a0,a5
	jalr	a4
.LVL1:
	sd	a0,-24(s0)
	...
	call	DebugPrintLevelEnabled
	mv	a5,a0
	.loc 1 51 44 discriminator 1
	beq	a5,zero,.L8
	.loc 1 51 84 discriminator 2
	ld	a3,-24(s0)
	lla	a2,__FUNCTION__.8243
	lla	a1,.LC2
	li	a0,64
...
.L9:
	...
	ld	a3,-40(s0)
	ld	a2,-48(s0)
	lla	a1,gEfiRngAlgorithmSp80090Hmac256Guid
	mv	a0,a5
	jalr	a4
.LVL2:
	sd	a0,-24(s0)
	...
	call	DebugPrintLevelEnabled
	mv	a5,a0
	.loc 1 57 44 discriminator 1
	beq	a5,zero,.L10
	.loc 1 57 84 discriminator 2
	ld	a3,-24(s0)
	lla	a2,__FUNCTION__.8243
	lla	a1,.LC3
	li	a0,64
...
.L11:
	...
	ld	a3,-40(s0)
	ld	a2,-48(s0)
	lla	a1,gEfiRngAlgorithmSp80090Hash256Guid
	mv	a0,a5
	jalr	a4
.LVL3:
	sd	a0,-24(s0)
	...
	.loc 1 63 11
	beq	a5,zero,.L12
	.loc 1 63 45 discriminator 1
	li	a0,64
	call	DebugPrintLevelEnabled
	mv	a5,a0
	.loc 1 63 44 discriminator 1
	beq	a5,zero,.L12
	.loc 1 63 84 discriminator 2
	ld	a3,-24(s0)
	lla	a2,__FUNCTION__.8243
	lla	a1,.LC4
	li	a0,64
...
.LVL4:
	...
	.loc 1 69 11
	beq	a5,zero,.L14
	.loc 1 69 45 discriminator 1
	li	a0,64
	call	DebugPrintLevelEnabled
	mv	a5,a0
	.loc 1 69 44 discriminator 1
	beq	a5,zero,.L14
	.loc 1 69 84 discriminator 2
	ld	a3,-24(s0)
	lla	a2,__FUNCTION__.8243
	lla	a1,.LC4
	li	a0,64
...
.L15:
	...
	call	DebugPrintLevelEnabled
	mv	a5,a0
	.loc 1 74 44 discriminator 1
	beq	a5,zero,.L16
	.loc 1 74 84 discriminator 2
	ld	a3,-24(s0)
	lla	a2,__FUNCTION__.8243
	lla	a1,.LC5
	li	a5,1
...
.L17:
	...
	.cfi_endproc
.LFE0:
	.size	GenerateRandomNumberViaNist800Algorithm, .-GenerateRandomNumberViaNist800Algorithm
...
.L19:
	...
	li	a1,2
	ld	a0,-40(s0)
	call	GenerateRandomNumberViaNist800Algorithm
	sd	a0,-24(s0)
	.loc 1 105 9
	ld	a5,-24(s0)
	.loc 1 105 6
...
.LFE4:
	...
	.section	.rodata.__FUNCTION__.8243,"a"
	.align	3
	.type	__FUNCTION__.8243, @object
	.size	__FUNCTION__.8243, 40
__FUNCTION__.8243:
	.string	"GenerateRandomNumberViaNist800Algorithm"
	.text
.Letext0:
	...
	.file 15 "/home/xephyr/Documents/edk2/Build/Mde/DEBUG_GCC5/RISCV64/MdePkg/Library/DxeRngLib/DxeRngLib/DEBUG/AutoGen.h"
	.file 16 "/home/xephyr/Documents/edk2/MdePkg/Include/Library/UefiBootServicesTableLib.h"
	.file 17 "/home/xephyr/Documents/edk2/MdePkg/Include/Protocol/Rng.h"
...
.LASF38:
	.string	"Second"
.LASF324:
	.string	"/home/xephyr/Documents/edk2/MdePkg/Library/DxeRngLib/DxeRngLib.c"
.LASF232:
...
.LASF312:
	.string	"gEfiRngAlgorithmX931AesGuid"
.LASF273:
	.string	"CopyMem"
.LASF85:
...
.LASF325:
	.string	"/home/xephyr/Documents/edk2/Build/Mde/DEBUG_GCC5/RISCV64/MdePkg/Library/DxeRngLib/DxeRngLib"
.LASF57:
...
.LASF311:
	.string	"gEfiRngAlgorithmX9313DesGuid"
.LASF257:
	.string	"UnloadImage"
.LASF318:
