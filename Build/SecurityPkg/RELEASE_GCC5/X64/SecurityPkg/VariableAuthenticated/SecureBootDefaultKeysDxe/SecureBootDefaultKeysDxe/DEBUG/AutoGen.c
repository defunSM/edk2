...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xC937FCB7, 0x25AC, 0x4376, {0x89, 0xA2, 0x4E, 0xA8, 0xB3, 0x17, 0xDE, 0x83}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "SecureBootDefaultKeysDxe";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gDefaultPKFileGuid = { 0x85254ea7, 0x4759, 0x4fc4, { 0x82, 0xd4, 0x5e, 0xed, 0x5f, 0xb0, 0xa4, 0xa0 } };
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gDefaultKEKFileGuid = { 0x6f64916e, 0x9f7a, 0x4c35, { 0xb9, 0x52, 0xcd, 0x04, 0x1e, 0xfb, 0x05, 0xa3 } };
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gDefaultdbFileGuid = { 0xc491d352, 0x7623, 0x4843, { 0xac, 0xcc, 0x27, 0x91, 0xa7, 0x57, 0x44, 0x21 } };
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gDefaultdbxFileGuid = { 0x5740766a, 0x718e, 0x4dc0, { 0x99, 0x35, 0xc3, 0x6f, 0x7d, 0x3f, 0x88, 0x4f } };
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gDefaultdbtFileGuid = { 0x36c513ee, 0xa338, 0x4976, { 0xa0, 0xfb, 0x6d, 0xdb, 0xa3, 0xda, 0xfe, 0x87 } };
...
{
  return SecureBootDefaultKeysEntryPoint (ImageHandle, SystemTable);
}
