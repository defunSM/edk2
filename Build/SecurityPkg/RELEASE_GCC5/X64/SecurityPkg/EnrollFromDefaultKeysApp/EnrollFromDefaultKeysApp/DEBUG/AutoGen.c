...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x6F18CB2F, 0x1293, 0x4BC1, {0xAB, 0xB8, 0x35, 0xF8, 0x4C, 0x71, 0x81, 0x2E}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "EnrollFromDefaultKeysApp";
