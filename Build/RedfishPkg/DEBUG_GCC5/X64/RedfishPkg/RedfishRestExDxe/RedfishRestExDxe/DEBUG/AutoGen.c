...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xB64702DA, 0xE6B5, 0x43c8, {0x8C, 0xE8, 0xD2, 0x53, 0x07, 0x1E, 0x9D, 0x6C}};

GLOBAL_REMOVE_IF_UNREFERENCED GUID gEdkiiDscPlatformGuid = {0xc4352870, 0x5232, 0x11e7, {0x95, 0x22, 0x00, 0x50, 0x56, 0xc0, 0x00, 0x08}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "RedfishRestExDxe";

// Guids
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiRedfishPkgTokenSpaceGuid = { 0x4fdbccb7, 0xe829, 0x4b4c, { 0x88, 0x87, 0xb2, 0x3f, 0xd7, 0x25, 0x4b, 0x85 }};
...
// Protocols
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiRestExServiceBindingProtocolGuid = { 0x456bbe01, 0x99d0, 0x45ea, { 0xbb, 0x5f, 0x16, 0xd8, 0x4b, 0xed, 0xc5, 0x59 }};
...
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_PcdRedfishRestExServiceAccessModeInBand = _PCD_VALUE_PcdRedfishRestExServiceAccessModeInBand;
...
#define _PCD_TOKEN_PcdMaxHttpChunkTransfer  19U
...
#define _PCD_TOKEN_PcdHttpIoTimeout  18U
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdHttpIoTimeout = _PCD_VALUE_PcdHttpIoTimeout;
...
{
  return RedfishRestExDriverEntryPoint (ImageHandle, SystemTable);
}
