...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xDED60489, 0x979C, 0x4B5A, {0x8E, 0xE4, 0x40, 0x68, 0xB0, 0xCC, 0x38, 0xDC}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "OpalPasswordPei";
...
#define _PCD_TOKEN_PcdPciExpressBaseAddress  23U
...
#define _PCD_TOKEN_PcdPciExpressBaseSize  24U
...
{
  return OpalPasswordPeiInit (FileHandle, PeiServices);
}
