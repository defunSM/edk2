...
.LC0:
	...
	.align	3
.LC1:
	.string	"/home/xephyr/Documents/edk2/MdePkg/Library/BaseMemoryLib/ZeroMemWrapper.c"
	.align	3
.LC2:
...
ZeroMem:
.LFB0:
	.file 1 "/home/xephyr/Documents/edk2/MdePkg/Library/BaseMemoryLib/ZeroMemWrapper.c"
	.loc 1 42 1
	.cfi_startproc
	addi	sp,sp,-32
...
.L4:
	...
	.loc 1 48 11
	beq	a5,zero,.L5
	.loc 1 48 78 discriminator 1
	ld	a5,-24(s0)
	.loc 1 48 92 discriminator 1
	neg	a5,a5
	.loc 1 48 40 discriminator 1
	ld	a4,-32(s0)
	bleu	a4,a5,.L5
	.loc 1 48 101 discriminator 2
	lla	a2,.LC2
	li	a1,48
	lla	a0,.LC1
	call	UnitTestDebugAssert
