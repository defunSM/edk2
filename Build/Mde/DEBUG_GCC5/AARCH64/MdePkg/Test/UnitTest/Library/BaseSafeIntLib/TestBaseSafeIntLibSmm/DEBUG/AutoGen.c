...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x2F2A1907, 0xB1B4, 0x4E33, {0x8B, 0x83, 0x62, 0xA6, 0x0A, 0xB4, 0xF0, 0xD4}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "TestBaseSafeIntLibSmm";
  ...
  )
{
  ...
  if (SetJump (&mJumpContext) == 0) {
    ExitDriver (DxeEntryPoint (ImageHandle, SystemTable));
    ASSERT (FALSE);
  }
