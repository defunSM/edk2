...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x8FF4C129, 0xC2EF, 0x445D, {0x86, 0x58, 0x9A, 0x34, 0x2A, 0x1F, 0xCC, 0x4D}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "FmpDependencyLibUnitTestsUefi";
...
{
  return FmpDependencyLibUnitTestAppEntry (ImageHandle, SystemTable);
}
