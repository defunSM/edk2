...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x458CE95A, 0x4942, 0x09A9, {0x5D, 0x21, 0xA6, 0xB1, 0x6D, 0x5D, 0xAD, 0x7F}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "RedfishCredentialDxe";
...
{
  return RedfishCredentialDxeDriverEntryPoint (ImageHandle, SystemTable);
}
