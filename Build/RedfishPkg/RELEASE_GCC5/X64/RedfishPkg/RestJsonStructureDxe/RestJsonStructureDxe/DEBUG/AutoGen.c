...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x83FAAFBF, 0xFC4B, 0x469F, {0x89, 0x2A, 0x79, 0x8E, 0x66, 0xA6, 0xF5, 0x0A}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "RestJsonStructureDxe";
...
// Protocols
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiRestJsonStructureProtocolGuid = { 0xa9a048f6, 0x48a0, 0x4714, {0xb7, 0xda, 0xa9, 0xad,0x87, 0xd4, 0xda, 0xc9 }};
...
{
  return RestJsonStructureEntryPoint (ImageHandle, SystemTable);
}
...
{
  return RestJsonStructureUnload (ImageHandle);
}
