...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x7D910602, 0xED53, 0x45E6, {0x82, 0x6E, 0x82, 0x66, 0x70, 0x5B, 0x97, 0x34}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "TestBaseSafeIntLibPei";
...
{
  return PeiEntryPoint (FileHandle, PeiServices);
}
