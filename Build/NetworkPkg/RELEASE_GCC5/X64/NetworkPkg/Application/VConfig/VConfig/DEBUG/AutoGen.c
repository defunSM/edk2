...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x87E36301, 0x0406, 0x44db, {0xAA, 0xF3, 0x9E, 0x0E, 0x59, 0x1F, 0x37, 0x25}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "VConfig";
...
#define _PCD_TOKEN_PcdUefiFileHandleLibPrintBufferSize  24U
...
#define _PCD_TOKEN_PcdShellLibAutoInitialize  38U
...
#define _PCD_TOKEN_PcdShellPrintBufferSize  39U
...
{
  return VlanConfigMain (ImageHandle, SystemTable);
}
