...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x89122868, 0xBCFD, 0x49E8, {0x88, 0xA3, 0x06, 0x63, 0x5C, 0xB7, 0xB3, 0xCF}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "DynamicTableManagerDxe";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEdkiiConfigurationManagerProtocolGuid = { 0xd85a4835, 0x5a82, 0x4894, { 0xac, 0x2, 0x70, 0x6f, 0x43, 0xd5, 0x97, 0x8e } };
...
{
  return DynamicTableManagerDxeInitialize (ImageHandle, SystemTable);
}
