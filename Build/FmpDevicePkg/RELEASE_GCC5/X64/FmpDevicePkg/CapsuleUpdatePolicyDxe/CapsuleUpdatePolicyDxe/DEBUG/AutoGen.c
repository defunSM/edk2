...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x86F67A12, 0x2E32, 0x44FC, {0x8D, 0x6C, 0x79, 0x01, 0xE2, 0xB5, 0x64, 0x9A}};

GLOBAL_REMOVE_IF_UNREFERENCED GUID gEdkiiDscPlatformGuid = {0x0af3d540, 0x27c6, 0x11e8, {0x82, 0x8b, 0xf8, 0x59, 0x71, 0x77, 0xa0, 0x0a}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "CapsuleUpdatePolicyDxe";
...
// Protocols
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEdkiiCapsuleUpdatePolicyProtocolGuid = { 0x487784c5, 0x6299, 0x4ba6, { 0xb0, 0x96, 0x5c, 0xc5, 0x27, 0x7c, 0xf7, 0x57 } };
...
#define _PCD_TOKEN_PcdUnitTestLogLevel  27U
...
{
  return CapsuleUpdatePolicyInitialize (ImageHandle, SystemTable);
}
