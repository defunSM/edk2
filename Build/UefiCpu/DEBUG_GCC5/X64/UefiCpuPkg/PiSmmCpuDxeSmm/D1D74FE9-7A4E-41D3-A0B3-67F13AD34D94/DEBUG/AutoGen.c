...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xD1D74FE9, 0x7A4E, 0x41D3, {0xA0, 0xB3, 0x67, 0xF1, 0x3A, 0xD3, 0x4D, 0x94}};
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gMsegSmramGuid = { 0x5802bce4, 0xeeee, 0x4e33, { 0xa1, 0x30, 0xeb, 0xad, 0x27, 0xf0, 0xe4, 0x39 }};
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiMmMpProtocolGuid = { 0x5d5450d7, 0x990c, 0x4180, { 0xa8, 0x3, 0x8e, 0x63, 0xf0, 0x60, 0x83, 0x7 }};
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiSmMonitorInitProtocolGuid = { 0x228f344d, 0xb3de, 0x43bb, { 0xa4, 0xd7, 0xea, 0x20, 0xb, 0x1b, 0x14, 0x82 }};

// Definition of SkuId Array
GLOBAL_REMOVE_IF_UNREFERENCED UINT64 _gPcd_SkuId_Array[] = {0x0};

// Definition of PCDs used in this module
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdCpuSmmMpTokenCountPerChunk = _PCD_VALUE_PcdCpuSmmMpTokenCountPerChunk;
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT8 _gPcd_FixedAtBuild_PcdCpuSmmSyncMode = _PCD_VALUE_PcdCpuSmmSyncMode;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdCpuSmmShadowStackSize = _PCD_VALUE_PcdCpuSmmShadowStackSize;
...
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_PcdCpuSmmRestrictedMemoryAccess = _PCD_VALUE_PcdCpuSmmRestrictedMemoryAccess;
...
#define _PCD_TOKEN_PcdPciExpressBaseSize  20U
...
#define _PCD_VALUE_PcdCpuMsegSize  0x200000U
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdCpuMsegSize = _PCD_VALUE_PcdCpuMsegSize;
...
#define _PCD_VALUE_PcdCpuSmmStmExceptionStackSize  0x1000U
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdCpuSmmStmExceptionStackSize = _PCD_VALUE_PcdCpuSmmStmExceptionStackSize;
  ...
  )
{
  ...
  Status = SmmCpuFeaturesLibStmConstructor (ImageHandle, SystemTable);
  ASSERT_EFI_ERROR (Status);
