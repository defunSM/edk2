...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x7BD9DDF7, 0x8B83, 0x488E, {0xAE, 0xC9, 0x24, 0xC7, 0x86, 0x10, 0x28, 0x9C}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "VirtioFsDxe";
...
{
  return VirtioFsEntryPoint (ImageHandle, SystemTable);
}
