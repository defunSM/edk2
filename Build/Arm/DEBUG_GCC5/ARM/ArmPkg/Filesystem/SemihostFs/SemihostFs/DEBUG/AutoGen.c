...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xC5B9C74A, 0x6D72, 0x4719, {0x99, 0xAB, 0xC5, 0x9F, 0x19, 0x90, 0x91, 0xEB}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "SemihostFs";
...
{
  return SemihostFsEntryPoint (ImageHandle, SystemTable);
}
