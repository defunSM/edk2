...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x389B16DB, 0xF622, 0x424C, {0x90, 0x00, 0x9E, 0x43, 0xC6, 0x9C, 0xBF, 0x71}};

GLOBAL_REMOVE_IF_UNREFERENCED GUID gEdkiiDscPlatformGuid = {0x7420CC7E, 0x334E, 0x4EFF, {0xB9, 0x74, 0xA3, 0x96, 0x13, 0x45, 0x51, 0x68}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "SampleUnitTestSmm";
