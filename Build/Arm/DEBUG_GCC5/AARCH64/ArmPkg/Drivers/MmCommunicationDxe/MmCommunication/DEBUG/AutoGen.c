...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x09EE81D3, 0xF15E, 0x43F4, {0x85, 0xB4, 0xCB, 0x98, 0x73, 0xDA, 0x5D, 0x6B}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "ArmMmCommunication";
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT64 _gPcd_FixedAtBuild_PcdMmBufferBase = _PCD_VALUE_PcdMmBufferBase;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT64 _gPcd_FixedAtBuild_PcdMmBufferSize = _PCD_VALUE_PcdMmBufferSize;
...
{
  return MmCommunication2Initialize (ImageHandle, SystemTable);
}
