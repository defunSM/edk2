...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xEADD5061, 0x93EF, 0x4CCC, {0x84, 0x50, 0xF7, 0x8A, 0x7F, 0x08, 0x20, 0xF0}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "Tcg2ConfigPei";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiTpmDeviceSelectedGuid = { 0x7f4158d3, 0x74d, 0x456d, { 0x8c, 0xb2, 0x1, 0xf9, 0xc8, 0xf7, 0x9d, 0xaa } };
...
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_PcdTpmAutoDetection = _PCD_VALUE_PcdTpmAutoDetection;
...
{
  return Tcg2ConfigPeimEntryPoint (FileHandle, PeiServices);
}
