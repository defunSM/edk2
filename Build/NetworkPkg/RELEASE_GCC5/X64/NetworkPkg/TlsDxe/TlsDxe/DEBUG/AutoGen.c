...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x3aceb0c0, 0x3c72, 0x11e4, {0x9a, 0x56, 0x74, 0xd4, 0x35, 0x05, 0x26, 0x46}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "TlsDxe";
...
{
  return TlsDriverEntryPoint (ImageHandle, SystemTable);
}
