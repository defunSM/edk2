...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xCE32C647, 0xCAD7, 0x4099, {0x94, 0x63, 0x65, 0x3B, 0x93, 0x2C, 0x16, 0x91}};

GLOBAL_REMOVE_IF_UNREFERENCED GUID gEdkiiDscPlatformGuid = {0x80B12646, 0x9A30, 0x4516, {0xAA, 0xBF, 0xDE, 0x19, 0x19, 0xB5, 0x73, 0xE3}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "FmpDependencyLibUnitTestsHost";
...
#define _PCD_TOKEN_PcdUnitTestLogLevel  10U
