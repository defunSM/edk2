...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xE2EA6F47, 0xE678, 0x47FA, {0x8C, 0x1B, 0x02, 0xA0, 0x3E, 0x82, 0x5C, 0x6E}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "TcgMorLockSmm";
  ...
  )
{
  ...
  if (SetJump (&mJumpContext) == 0) {
    ExitDriver (MorLockDriverEntryPointSmm (ImageHandle, SystemTable));
    ASSERT (FALSE);
  }
