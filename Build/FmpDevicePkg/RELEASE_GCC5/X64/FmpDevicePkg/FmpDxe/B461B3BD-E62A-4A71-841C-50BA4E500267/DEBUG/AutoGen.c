...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xB461B3BD, 0xE62A, 0x4A71, {0x84, 0x1C, 0x50, 0xBA, 0x4E, 0x50, 0x02, 0x67}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "FmpDxe";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gFmpDevicePkgTokenSpaceGuid = { 0x40b2d964, 0xfe11, 0x40dc, { 0x82, 0x83, 0x2e, 0xfb, 0xda, 0x29, 0x53, 0x56 } };
...
{
  return FmpDxeEntryPoint (ImageHandle, SystemTable);
}
