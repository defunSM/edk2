...
.LC1:
	...
	.align	3
.LC2:
	.string	"/home/xephyr/Documents/edk2/MdePkg/Library/DxeSmbusLib/DxeSmbusLib.c"
	.align	3
.LC3:
	.string	"mSmbus != ((void *) 0)"
	.section	.text.SmbusLibConstructor,"ax",@progbits
	.align	1
	.globl	SmbusLibConstructor
	.type	SmbusLibConstructor, @function
SmbusLibConstructor:
.LFB0:
	.file 1 "/home/xephyr/Documents/edk2/MdePkg/Library/DxeSmbusLib/DxeSmbusLib.c"
	.loc 1 37 1
	.cfi_startproc
	addi	sp,sp,-48
	...
	lla	a2,mSmbus
	li	a1,0
	lla	a0,gEfiSmbusHcProtocolGuid
	jalr	a5
.LVL0:
	sd	a0,-24(s0)
	.loc 1 41 12
	...
	bge	a5,zero,.L2
	.loc 1 41 91 discriminator 2
	call	DebugPrintEnabled
	mv	a5,a0
	.loc 1 41 90 discriminator 2
	beq	a5,zero,.L3
	.loc 1 41 124 discriminator 3
	li	a5,1
	slli	a0,a5,31
	call	DebugPrintLevelEnabled
	mv	a5,a0
	.loc 1 41 123 discriminator 3
	beq	a5,zero,.L3
	.loc 1 41 163 discriminator 5
	ld	a2,-24(s0)
	lla	a1,.LC0
	li	a5,1
	slli	a0,a5,31
...
.L2:
	...
	.loc 1 42 11
	beq	a5,zero,.L4
	.loc 1 42 41 discriminator 1
	lla	a5,mSmbus
	ld	a5,0(a5)
	.loc 1 42 40 discriminator 1
	bne	a5,zero,.L4
	.loc 1 42 70 discriminator 2
	lla	a2,.LC3
	li	a1,42
	lla	a0,.LC2
	call	UnitTestDebugAssert
.L4:
	...
	.cfi_endproc
.LFE0:
	.size	SmbusLibConstructor, .-SmbusLibConstructor
...
.Letext0:
	...
	.file 16 "/home/xephyr/Documents/edk2/MdePkg/Include/IndustryStandard/SmBus.h"
	.file 17 "/home/xephyr/Documents/edk2/MdePkg/Include/Protocol/SmbusHc.h"
...
.LASF7:
	.string	"UINT16"
.LASF336:
	.string	"EFI_SMBUS_NOTIFY_FUNCTION"
.LASF15:
	.string	"CHAR8"
.LASF25:
...
.LASF238:
	.string	"AllocatePool"
.LASF335:
	.string	"EFI_SMBUS_HC_PROTOCOL_GET_ARP_MAP"
.LASF1:
	.string	"INT64"
.LASF156:
...
.LASF241:
	.string	"SetTimer"
.LASF334:
	.string	"EFI_SMBUS_HC_PROTOCOL_ARP_DEVICE"
.LASF125:
...
.LASF337:
	.string	"EFI_SMBUS_HC_PROTOCOL_NOTIFY"
.LASF274:
	.string	"SetMem"
.LASF154:
...
.LASF333:
	.string	"EFI_SMBUS_HC_EXECUTE_OPERATION"
.LASF169:
