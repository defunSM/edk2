...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xA7388B6C, 0x7274, 0x4717, {0x96, 0x49, 0xBD, 0xC5, 0xDF, 0xD1, 0xFC, 0xBE}};

GLOBAL_REMOVE_IF_UNREFERENCED GUID gEdkiiDscPlatformGuid = {0xF74AF7C6, 0x698C, 0x4EBA, {0xBA, 0x49, 0xFF, 0x68, 0x16, 0x91, 0x63, 0x54}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "VariableLockRequestToLockUnitTest";
...
#define _PCD_TOKEN_PcdControlFlowEnforcementPropertyMask  2U
...
#define _PCD_TOKEN_PcdDebugClearMemoryValue  3U
...
#define _PCD_TOKEN_PcdAllowVariablePolicyEnforcementDisable  1U
...
#define _PCD_VALUE_PcdAllowVariablePolicyEnforcementDisable  1U
