# 1 "/home/xephyr/Documents/edk2/MdePkg/Library/PciSegmentLibSegmentInfo/DxeRuntimePciSegmentLib.c"
...
# 1 "<command-line>" 2
# 1 "/home/xephyr/Documents/edk2/MdePkg/Library/PciSegmentLibSegmentInfo/DxeRuntimePciSegmentLib.c"
# 12 "/home/xephyr/Documents/edk2/MdePkg/Library/PciSegmentLibSegmentInfo/DxeRuntimePciSegmentLib.c"
...
# 13 "/home/xephyr/Documents/edk2/MdePkg/Library/PciSegmentLibSegmentInfo/DxeRuntimePciSegmentLib.c" 2
...
# 15 "/home/xephyr/Documents/edk2/MdePkg/Library/PciSegmentLibSegmentInfo/DxeRuntimePciSegmentLib.c" 2
...
# 16 "/home/xephyr/Documents/edk2/MdePkg/Library/PciSegmentLibSegmentInfo/DxeRuntimePciSegmentLib.c" 2
...
# 17 "/home/xephyr/Documents/edk2/MdePkg/Library/PciSegmentLibSegmentInfo/DxeRuntimePciSegmentLib.c" 2
...
# 18 "/home/xephyr/Documents/edk2/MdePkg/Library/PciSegmentLibSegmentInfo/DxeRuntimePciSegmentLib.c" 2
...
# 19 "/home/xephyr/Documents/edk2/MdePkg/Library/PciSegmentLibSegmentInfo/DxeRuntimePciSegmentLib.c" 2
...
EFI_EVENT mDxeRuntimePciSegmentLibVirtualNotifyEvent = ((void *) 0);
...
PCI_SEGMENT_RUNTIME_REGISTRATION_TABLE *mDxeRuntimePciSegmentLibRegistrationTable = ((void *) 0);




UINTN mDxeRuntimePciSegmentLibLastRuntimeRange = 0;
# 56 "/home/xephyr/Documents/edk2/MdePkg/Library/PciSegmentLibSegmentInfo/DxeRuntimePciSegmentLib.c"
void
  ...
  )
{
  ...
  if (mDxeRuntimePciSegmentLibRegistrationTable == ((void *) 0)) {
    return;
  }
  ...
  for (Index = 0; Index < mDxeRuntimePciSegmentLibNumberOfRuntimeRanges; Index++) {
    ...
    do { if (DebugAssertEnabled ()) { if ((((INTN)(RETURN_STATUS)(Status)) < 0)) { do { if (DebugPrintEnabled ()) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "\nASSERT_EFI_ERROR (Status = %r)\n", Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1))); UnitTestDebugAssert ("/home/xephyr/Documents/edk2/MdePkg/Library/PciSegmentLibSegmentInfo/DxeRuntimePciSegmentLib.c", 79, "!EFI_ERROR (Status)"); } } } while (((BOOLEAN)(0==1)));
  }
  ...
  do { if (DebugAssertEnabled ()) { if ((((INTN)(RETURN_STATUS)(Status)) < 0)) { do { if (DebugPrintEnabled ()) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "\nASSERT_EFI_ERROR (Status = %r)\n", Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1))); UnitTestDebugAssert ("/home/xephyr/Documents/edk2/MdePkg/Library/PciSegmentLibSegmentInfo/DxeRuntimePciSegmentLib.c", 86, "!EFI_ERROR (Status)"); } } } while (((BOOLEAN)(0==1)));
}
# 100 "/home/xephyr/Documents/edk2/MdePkg/Library/PciSegmentLibSegmentInfo/DxeRuntimePciSegmentLib.c"
EFI_STATUS
  ...
  )
{
  ...
  do { if (DebugAssertEnabled ()) { if ((((INTN)(RETURN_STATUS)(Status)) < 0)) { do { if (DebugPrintEnabled ()) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "\nASSERT_EFI_ERROR (Status = %r)\n", Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1))); UnitTestDebugAssert ("/home/xephyr/Documents/edk2/MdePkg/Library/PciSegmentLibSegmentInfo/DxeRuntimePciSegmentLib.c", 119, "!EFI_ERROR (Status)"); } } } while (((BOOLEAN)(0==1)));

  return Status;
}
# 135 "/home/xephyr/Documents/edk2/MdePkg/Library/PciSegmentLibSegmentInfo/DxeRuntimePciSegmentLib.c"
EFI_STATUS
  ...
  )
{
  ...
  do { if (DebugAssertEnabled ()) { if ((((INTN)(RETURN_STATUS)(Status)) < 0)) { do { if (DebugPrintEnabled ()) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "\nASSERT_EFI_ERROR (Status = %r)\n", Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1))); UnitTestDebugAssert ("/home/xephyr/Documents/edk2/MdePkg/Library/PciSegmentLibSegmentInfo/DxeRuntimePciSegmentLib.c", 156, "!EFI_ERROR (Status)"); } } } while (((BOOLEAN)(0==1)));

  return Status;
}
# 179 "/home/xephyr/Documents/edk2/MdePkg/Library/PciSegmentLibSegmentInfo/DxeRuntimePciSegmentLib.c"
RETURN_STATUS
  ...
  )
{
  ...
  if (sizeof (UINTN) == sizeof (UINT32)) {
    do { if (DebugAssertEnabled ()) { if (!(EcamAddress < 0x0000000100000000ULL)) { UnitTestDebugAssert ("/home/xephyr/Documents/edk2/MdePkg/Library/PciSegmentLibSegmentInfo/DxeRuntimePciSegmentLib.c", 208, "EcamAddress < 0x0000000100000000ULL"); ; } } } while (((BOOLEAN)(0==1)));
  }
  ...
  Status = gDS->SetMemorySpaceAttributes (Address, 0x00001000, Descriptor.Attributes | 0x8000000000000000ULL);
  if ((((INTN)(RETURN_STATUS)(Status)) < 0)) {
    return ((RETURN_STATUS)(0x8000000000000000ULL | (3)));
  }
...
# 264 "/home/xephyr/Documents/edk2/MdePkg/Library/PciSegmentLibSegmentInfo/DxeRuntimePciSegmentLib.c"
UINTN
PciSegmentLibVirtualAddress (
  UINTN Address
  )
{
  ...
  if (mDxeRuntimePciSegmentLibRegistrationTable[mDxeRuntimePciSegmentLibLastRuntimeRange].PhysicalAddress == (Address & (~(UINTN)0xFFF))) {



    return (Address & 0xFFF) + mDxeRuntimePciSegmentLibRegistrationTable[mDxeRuntimePciSegmentLibLastRuntimeRange].VirtualAddress;
  }
  ...
  for (Index = 0; Index < mDxeRuntimePciSegmentLibNumberOfRuntimeRanges; Index++) {
    if (mDxeRuntimePciSegmentLibRegistrationTable[Index].PhysicalAddress == (Address & (~(UINTN)0xFFF))) {
      ...
      return (Address & 0xFFF) + mDxeRuntimePciSegmentLibRegistrationTable[Index].VirtualAddress;
    }
  }
  ...
  do { if (DebugAssertEnabled ()) { if (!(((BOOLEAN)(0==1)))) { UnitTestDebugAssert ("/home/xephyr/Documents/edk2/MdePkg/Library/PciSegmentLibSegmentInfo/DxeRuntimePciSegmentLib.c", 306, "((BOOLEAN)(0==1))"); ; } } } while (((BOOLEAN)(0==1)));
  CpuBreakpoint ();
