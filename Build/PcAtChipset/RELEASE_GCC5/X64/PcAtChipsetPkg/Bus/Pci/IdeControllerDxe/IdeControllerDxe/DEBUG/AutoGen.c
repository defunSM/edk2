...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x99549F44, 0x49BB, 0x4820, {0xB9, 0xD2, 0x90, 0x13, 0x29, 0x41, 0x2D, 0x67}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "IdeController";
...
{
  return InitializeIdeControllerDriver (ImageHandle, SystemTable);
}
