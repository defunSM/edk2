# 1 "/home/xephyr/Documents/edk2/MdePkg/Library/BaseLib/FilePaths.c"
...
# 9 "/home/xephyr/Documents/edk2/MdePkg/Library/BaseLib/FilePaths.c" 2
...
# 10 "/home/xephyr/Documents/edk2/MdePkg/Library/BaseLib/FilePaths.c" 2
# 20 "/home/xephyr/Documents/edk2/MdePkg/Library/BaseLib/FilePaths.c"
BOOLEAN
  ...
  )
{
  ...
  for ( Walker = Path, LastSlash = ((void *) 0)
      ; Walker != ((void *) 0) && *Walker != 0x0000
      ; Walker++
     ){
    if (*Walker == L'\\' && *(Walker + 1) != 0x0000) {
      LastSlash = Walker+1;
    } else if (*Walker == L':' && *(Walker + 1) != L'\\' && *(Walker + 1) != 0x0000) {
      LastSlash = Walker+1;
    }
  }
  if (LastSlash != ((void *) 0)) {
...
# 62 "/home/xephyr/Documents/edk2/MdePkg/Library/BaseLib/FilePaths.c"
CHAR16*
...
)
{
  ...
  for (TempString = Path; *TempString != 0x0000; TempString++) {
    if (*TempString == L'/') {
      *TempString = L'\\';
    }
  }
  ...
  while ((TempString = StrStr (Path, L"\\\\")) != ((void *) 0)) {
  ...
  while (((TempString = StrStr(Path, L"\\..")) != ((void *) 0)) &&
         ((*(TempString + 3) == L'\\') || (*(TempString + 3) == 0x0000))
        ) {
    *(TempString + 1) = 0x0000;
    PathRemoveLastItem(Path);
    if (*(TempString + 3) != 0x0000) {
