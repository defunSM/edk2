...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xE3121A26, 0xBB1C, 0x4A18, {0x8E, 0x23, 0x2E, 0xA3, 0xF0, 0x41, 0x22, 0x48}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "CpuIo2StandaloneMm";
...
{
  return StandaloneMmCpuIo2Initialize (ImageHandle, MmSystemTable);
}
