...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xE21F35A8, 0x42FF, 0x4050, {0x82, 0xD6, 0x93, 0xF7, 0xCD, 0xFA, 0x70, 0x73}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "PiSmmCommunicationSmm";
  ...
  )
{
  ...
  if (SetJump (&mJumpContext) == 0) {
    ExitDriver (PiSmmCommunicationSmmEntryPoint (ImageHandle, SystemTable));
    ASSERT (FALSE);
  }
