...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x0619f5c2, 0x4858, 0x4caa, {0xa8, 0x6a, 0x73, 0xa2, 0x1a, 0x18, 0xdf, 0x6b}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "GenericWatchdogDxe";
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT64 _gPcd_FixedAtBuild_PcdGenericWatchdogControlBase = _PCD_VALUE_PcdGenericWatchdogControlBase;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT64 _gPcd_FixedAtBuild_PcdGenericWatchdogRefreshBase = _PCD_VALUE_PcdGenericWatchdogRefreshBase;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdGenericWatchdogEl2IntrNum = _PCD_VALUE_PcdGenericWatchdogEl2IntrNum;
...
{
  return GenericWatchdogEntry (ImageHandle, SystemTable);
}
