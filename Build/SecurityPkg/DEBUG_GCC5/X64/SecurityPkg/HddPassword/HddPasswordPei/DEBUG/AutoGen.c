...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x91AD7375, 0x8E8E, 0x49D2, {0xA3, 0x43, 0x68, 0xBC, 0x78, 0x27, 0x39, 0x55}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "HddPasswordPei";
...
{
  return HddPasswordPeiInit (FileHandle, PeiServices);
}
