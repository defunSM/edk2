...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x42293093, 0x76B9, 0x4482, {0x8C, 0x02, 0x3B, 0xEF, 0xDE, 0xA9, 0xB3, 0x5D}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "TcgSmm";

// Guids
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiPhysicalPresenceGuid = { 0xf6499b1, 0xe9ad, 0x493d, { 0xb9, 0xc2, 0x2f, 0x90, 0x81, 0x5c, 0x6c, 0xbc }};
  ...
  )
{
  ...
  if (SetJump (&mJumpContext) == 0) {
    ExitDriver (InitializeTcgSmm (ImageHandle, SystemTable));
    ASSERT (FALSE);
  }
