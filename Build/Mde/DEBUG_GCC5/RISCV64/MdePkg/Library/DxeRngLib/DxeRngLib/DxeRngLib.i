# 1 "/home/xephyr/Documents/edk2/MdePkg/Library/DxeRngLib/DxeRngLib.c"
# 1 "/home/xephyr/Documents/edk2/Build/Mde/DEBUG_GCC5/RISCV64/MdePkg/Library/DxeRngLib/DxeRngLib//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/xephyr/Documents/edk2/Build/Mde/DEBUG_GCC5/RISCV64/MdePkg/Library/DxeRngLib/DxeRngLib/DEBUG/AutoGen.h" 1
# 16 "/home/xephyr/Documents/edk2/Build/Mde/DEBUG_GCC5/RISCV64/MdePkg/Library/DxeRngLib/DxeRngLib/DEBUG/AutoGen.h"
...
# 17 "/home/xephyr/Documents/edk2/Build/Mde/DEBUG_GCC5/RISCV64/MdePkg/Library/DxeRngLib/DxeRngLib/DEBUG/AutoGen.h" 2
...
# 9 "/home/xephyr/Documents/edk2/MdePkg/Library/DxeRngLib/DxeRngLib.c" 2
...
# 10 "/home/xephyr/Documents/edk2/MdePkg/Library/DxeRngLib/DxeRngLib.c" 2
...
# 11 "/home/xephyr/Documents/edk2/MdePkg/Library/DxeRngLib/DxeRngLib.c" 2
# 1 "/home/xephyr/Documents/edk2/MdePkg/Include/Library/RngLib.h" 1
# 23 "/home/xephyr/Documents/edk2/MdePkg/Include/Library/RngLib.h"
BOOLEAN

GetRandomNumber16 (
  UINT16 *Rand
  );
# 40 "/home/xephyr/Documents/edk2/MdePkg/Include/Library/RngLib.h"
BOOLEAN

GetRandomNumber32 (
  UINT32 *Rand
  );
# 57 "/home/xephyr/Documents/edk2/MdePkg/Include/Library/RngLib.h"
BOOLEAN

GetRandomNumber64 (
  UINT64 *Rand
  );
# 74 "/home/xephyr/Documents/edk2/MdePkg/Include/Library/RngLib.h"
BOOLEAN

GetRandomNumber128 (
  UINT64 *Rand
  );
# 12 "/home/xephyr/Documents/edk2/MdePkg/Library/DxeRngLib/DxeRngLib.c" 2
# 1 "/home/xephyr/Documents/edk2/MdePkg/Include/Protocol/Rng.h" 1
# 22 "/home/xephyr/Documents/edk2/MdePkg/Include/Protocol/Rng.h"
...
# 94 "/home/xephyr/Documents/edk2/MdePkg/Include/Protocol/Rng.h"
typedef
EFI_STATUS
( *EFI_RNG_GET_INFO) (
...
# 124 "/home/xephyr/Documents/edk2/MdePkg/Include/Protocol/Rng.h"
typedef
EFI_STATUS
( *EFI_RNG_GET_RNG) (
  EFI_RNG_PROTOCOL *This,
...
# 13 "/home/xephyr/Documents/edk2/MdePkg/Library/DxeRngLib/DxeRngLib.c" 2
# 27 "/home/xephyr/Documents/edk2/MdePkg/Library/DxeRngLib/DxeRngLib.c"
static
EFI_STATUS
  ...
  )
{
  ...
  if (Buffer == ((void *) 0)) {
      do { if (DebugPrintEnabled ()) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "%a: Buffer == NULL.\n", __FUNCTION__); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
      return ((RETURN_STATUS)(0x8000000000000000ULL | (2)));
  }

  Status = gBS->LocateProtocol (&gEfiRngProtocolGuid, ((void *) 0), (void **)&RngProtocol);
  if ((((INTN)(RETURN_STATUS)(Status)) < 0) || RngProtocol == ((void *) 0)) {
      do { if (DebugPrintEnabled ()) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "%a: Could not locate RNG prototocol, Status = %r\n", __FUNCTION__, Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
      return Status;
  }

  Status = RngProtocol->GetRNG (RngProtocol, &gEfiRngAlgorithmSp80090Ctr256Guid, BufferSize, Buffer);
  do { if (DebugPrintEnabled ()) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "%a: GetRNG algorithm CTR-256 - Status = %r\n", __FUNCTION__, Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  if (!(((INTN)(RETURN_STATUS)(Status)) < 0)) {
    return Status;
  }

  Status = RngProtocol->GetRNG (RngProtocol, &gEfiRngAlgorithmSp80090Hmac256Guid, BufferSize, Buffer);
  do { if (DebugPrintEnabled ()) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "%a: GetRNG algorithm HMAC-256 - Status = %r\n", __FUNCTION__, Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  if (!(((INTN)(RETURN_STATUS)(Status)) < 0)) {
    return Status;
  }

  Status = RngProtocol->GetRNG (RngProtocol, &gEfiRngAlgorithmSp80090Hash256Guid, BufferSize, Buffer);
  do { if (DebugPrintEnabled ()) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "%a: GetRNG algorithm Hash-256 - Status = %r\n", __FUNCTION__, Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  if (!(((INTN)(RETURN_STATUS)(Status)) < 0)) {
    return Status;
  }

  Status = RngProtocol->GetRNG (RngProtocol, ((void *) 0), BufferSize, Buffer);
  do { if (DebugPrintEnabled ()) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "%a: GetRNG algorithm Hash-256 - Status = %r\n", __FUNCTION__, Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  if (!(((INTN)(RETURN_STATUS)(Status)) < 0)) {
    return Status;
  }

  do { if (DebugPrintEnabled ()) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "%a: GetRNG() failed, staus = %r\n", __FUNCTION__, Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));

  return Status;
}
# 91 "/home/xephyr/Documents/edk2/MdePkg/Library/DxeRngLib/DxeRngLib.c"
BOOLEAN
...
# 122 "/home/xephyr/Documents/edk2/MdePkg/Library/DxeRngLib/DxeRngLib.c"
BOOLEAN
...
# 152 "/home/xephyr/Documents/edk2/MdePkg/Library/DxeRngLib/DxeRngLib.c"
BOOLEAN
...
# 182 "/home/xephyr/Documents/edk2/MdePkg/Library/DxeRngLib/DxeRngLib.c"
BOOLEAN
