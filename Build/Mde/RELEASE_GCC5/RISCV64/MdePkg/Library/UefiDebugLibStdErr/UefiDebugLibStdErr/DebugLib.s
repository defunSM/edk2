...
DebugPrint:
.LFB0:
	.file 1 "/home/xephyr/Documents/edk2/MdePkg/Library/UefiDebugLibStdErr/DebugLib.c"
	.loc 1 56 1
	.cfi_startproc
	addi	sp,sp,-112
...
.LC0:
	...
	.align	3
.LC1:
	.string	"/home/xephyr/Documents/edk2/MdePkg/Library/UefiDebugLibStdErr/DebugLib.c"
...
.LFB1:
	...
	.loc 1 96 13
	beq	a5,zero,.L4
	.loc 1 96 42 discriminator 1
	ld	a5,-544(s0)
	bne	a5,zero,.L4
	.loc 1 96 72 discriminator 2
	lla	a2,.LC0
	li	a1,96
	lla	a0,.LC1
...
.L8:
	...
	.loc 1 117 8
	beq	a5,zero,.L2
	.loc 1 117 48 discriminator 1
	lla	a5,mDebugST
	ld	a5,0(a5)
	ld	a5,80(a5)
	.loc 1 117 36 discriminator 1
	beq	a5,zero,.L2
	.loc 1 118 15
	lla	a5,mDebugST
	ld	a5,0(a5)
