...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x2366c20f, 0xe15a, 0x11e3, {0x8b, 0xf1, 0xe4, 0x11, 0x5b, 0x28, 0xbc, 0x50}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "HttpDxe";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEdkiiHttpCallbackProtocolGuid = {0x611114f1, 0xa37b, 0x4468, {0xa4, 0x36, 0x5b, 0xdd, 0xa1, 0x6a, 0xa2, 0x40}};
...
{
  return HttpDxeDriverEntryPoint (ImageHandle, SystemTable);
}
