...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x95E3669D, 0x34BE, 0x4775, {0xA6, 0x51, 0x7E, 0xA4, 0x1B, 0x69, 0xD8, 0x9E}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "Dhcp6Dxe";
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT8 _gPcd_FixedAtBuild_PcdDhcp6UidType = _PCD_VALUE_PcdDhcp6UidType;
...
{
  return Dhcp6DriverEntryPoint (ImageHandle, SystemTable);
}
