...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x99F03B99, 0x98D8, 0x49dd, {0xA8, 0xD3, 0x32, 0x19, 0xD0, 0xFF, 0xE4, 0x1E}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "Mtftp6Dxe";
...
{
  return Mtftp6DriverEntryPoint (ImageHandle, SystemTable);
}
