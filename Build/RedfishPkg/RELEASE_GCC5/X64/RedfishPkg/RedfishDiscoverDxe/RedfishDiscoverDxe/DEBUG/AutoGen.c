...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x28A76FE5, 0x43D7, 0x48A3, {0x97, 0x14, 0xC1, 0xB7, 0xBD, 0xD6, 0xDF, 0xB6}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "RedfishDiscoverDxe";
...
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_PcdRedfishDiscoverAccessModeInBand = _PCD_VALUE_PcdRedfishDiscoverAccessModeInBand;
...
{
  return RedfishDiscoverEntryPoint (ImageHandle, SystemTable);
}
...
{
  return RedfishDiscoverUnload (ImageHandle);
}
