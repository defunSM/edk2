...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x95487689, 0x9E30, 0x41AD, {0xB7, 0x73, 0x36, 0x50, 0xC9, 0x4B, 0xCB, 0xE2}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "TestBaseSafeIntLibHost";
