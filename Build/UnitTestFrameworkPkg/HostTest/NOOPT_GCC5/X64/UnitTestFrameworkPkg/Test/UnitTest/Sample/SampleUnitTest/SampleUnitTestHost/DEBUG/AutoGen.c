...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xCC0EA77E, 0xBF2D, 0x4134, {0xB4, 0x19, 0x0C, 0x02, 0xE1, 0x5C, 0xE0, 0x8E}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "SampleUnitTestHost";
