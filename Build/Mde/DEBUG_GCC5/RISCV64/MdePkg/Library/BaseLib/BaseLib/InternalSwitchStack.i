# 1 "/home/xephyr/Documents/edk2/MdePkg/Library/BaseLib/RiscV64/InternalSwitchStack.c"
...
# 1 "<command-line>" 2
# 1 "/home/xephyr/Documents/edk2/MdePkg/Library/BaseLib/RiscV64/InternalSwitchStack.c"
# 9 "/home/xephyr/Documents/edk2/MdePkg/Library/BaseLib/RiscV64/InternalSwitchStack.c"
...
# 10 "/home/xephyr/Documents/edk2/MdePkg/Library/BaseLib/RiscV64/InternalSwitchStack.c" 2
# 35 "/home/xephyr/Documents/edk2/MdePkg/Library/BaseLib/RiscV64/InternalSwitchStack.c"
void
  ...
  )
{
  ...
  do { if (DebugPrintEnabled ()) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "RISC-V InternalSwitchStack Entry:%x Context1:%x Context2:%x NewStack%x\n", EntryPoint, Context1, Context2, NewStack); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
                                                    ;
  ...
  do { if (DebugAssertEnabled ()) { if (!(((BOOLEAN)(0==1)))) { UnitTestDebugAssert ("/home/xephyr/Documents/edk2/MdePkg/Library/BaseLib/RiscV64/InternalSwitchStack.c", 54, "((BOOLEAN)(0==1))"); ; } } } while (((BOOLEAN)(0==1)));
}
