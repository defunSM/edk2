...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xD912C7BC, 0xF098, 0x4367, {0x92, 0xBA, 0xE9, 0x11, 0x08, 0x3C, 0x7B, 0x0E}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "Udp6Dxe";
...
{
  return Udp6DriverEntryPoint (ImageHandle, SystemTable);
}
